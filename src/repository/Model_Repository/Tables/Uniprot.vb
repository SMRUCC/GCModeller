#Region "Microsoft.VisualBasic::3d509b611d4422df05e0ee9ba738b89d, ..\repository\Model_Repository\Tables\Uniprot.vb"
...
Public Class Uniprot : Inherits DbFileSystemObject
    ...
    Public Shared Function CreateObject(Fasta As UniprotFasta, MD5 As String) As Uniprot
        Dim Entry As New Uniprot With {
            .Definition = Fasta.ProtName.MySqlEscaping,
            .GeneName = Fasta.GN,
            .LocusID = Fasta.EntryName,
            .MD5Hash = MD5,
            .OrganismSpecies = Fasta.OrgnsmSpName.MySqlEscaping,
            .PE = Fasta.PE,
            .SV = Fasta.SV,
