#Region "Microsoft.VisualBasic::f4feb7533eeb2779a0e4aafc4a03f3ce, DataMySql\Xfam\Rfam\Tables\family_ncbi.vb"
    ...
    ' Class family_ncbi
    ' 
    '     Properties: ncbi_id, rfam_acc, rfam_id
    ' 
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `family_ncbi` (`ncbi_id`, `rfam_id`, `rfam_acc`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `family_ncbi` (`ncbi_id`, `rfam_id`, `rfam_acc`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `family_ncbi` (`ncbi_id`, `rfam_id`, `rfam_acc`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `family_ncbi` (`ncbi_id`, `rfam_id`, `rfam_acc`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `family_ncbi` WHERE `rfam_acc` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `family_ncbi` SET `ncbi_id`='{0}', `rfam_id`='{1}', `rfam_acc`='{2}' WHERE `rfam_acc` = '{3}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, ncbi_id, rfam_id, rfam_acc)
        Else
        Return String.Format(INSERT_SQL, ncbi_id, rfam_id, rfam_acc)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, ncbi_id, rfam_id, rfam_acc)
        Else
        Return String.Format(REPLACE_SQL, ncbi_id, rfam_id, rfam_acc)
        End If
    End Function
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As family_ncbi
                         Return DirectCast(MyClass.MemberwiseClone, family_ncbi)
                     End Function
End Class
