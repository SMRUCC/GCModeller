package WriteSBML2_1_CellDesigner;
...
WriteSBML2_1_CellDesigner.pm

=head1 DESCRIPTION

Writes a Celldesigner SBML Level 2 Version 1 file.
...
sub writeSBML{
    ...
    my $output = new IO::File(">".$output_file."_2-1_CellDesigner.sbml");
...
sub writeListOfSpecies{
    ...
    if($species_ref->{$molecule->{'species'}}){
        ...
        $writer->characters("\n");
            ...
            $writer->characters("\n");
            $writer->endTag("celldesigner:speciesIdentity"); # hier vorher empty tag
            $writer->characters("\n");
