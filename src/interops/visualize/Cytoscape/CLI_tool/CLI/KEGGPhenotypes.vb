#Region "Microsoft.VisualBasic::bbbd6fa7b7002f88fb6945b83d4187cf, visualize\Cytoscape\CLI_tool\CLI\KEGGPhenotypes.vb"
...
Partial Module CLI
    ...
    <ArgumentAttribute("/reactions", False, CLITypes.File, PipelineTypes.undefined,
    ...
    <ArgumentAttribute("/enzyme", True, CLITypes.File,
    ...
    <ArgumentAttribute("/extended", True, CLITypes.Boolean,
