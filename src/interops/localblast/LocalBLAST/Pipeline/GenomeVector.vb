...
Namespace Pipeline
    ...
    Public Class GenomeVector : Implements INamedValue
        ...
        Public Function GetHierarchicalECNumberTerms() As Dictionary(Of String, Integer)
            Return GetHierarchicalECNumberTerms(terms)
        End Function
        ...
        ''' </summary>
        ''' <returns></returns>
        Public Shared Function GetHierarchicalECNumberTerms(terms As Dictionary(Of String, Integer)) As Dictionary(Of String, Integer)
