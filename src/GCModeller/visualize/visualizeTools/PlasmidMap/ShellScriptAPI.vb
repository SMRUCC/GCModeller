...
Namespace PlasmidMap
    ...
    <PackageAttribute("Data.Visualization.Plasmid_Map", Description:="Data visualization module for the bacteria plasmid object.", Category:=APICategories.UtilityTools)>
