...
Public Module Extensions
 ...
 _
    ...
    <Extension>
    Public Function DrawCatalogProfiling(Of T As ICOGCatalog)(res As Bitmap, genes As IEnumerable(Of T), left%, size As Size) As Bitmap
        Dim legend As Bitmap = genes.COGCatalogProfilingPlot(size)
