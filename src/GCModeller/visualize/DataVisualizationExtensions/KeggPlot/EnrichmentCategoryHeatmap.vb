#Region "Microsoft.VisualBasic::643a94f43cc3fd5eb91387f2ed53ffdc, visualize\DataVisualizationExtensions\KeggPlot\EnrichmentCategoryHeatmap.vb"
    ...
    '   Total Lines: 409
    '    Code Lines: 302 (73.84%)
    ' Comment Lines: 40 (9.78%)
    '    - Xml Docs: 45.00%
    ' 
    '   Blank Lines: 67 (16.38%)
    '     File Size: 18.76 KB
...
Public Class EnrichmentCategoryHeatmap : Inherits HeatMapPlot
    ...
    Protected Overrides Sub PlotInternal(ByRef g As IGraphics, canvas As GraphicsRegion)
        ...
        Dim legend_region As New Rectangle(rect.Right + delta, rect.Top, css.GetWidth(canvas.Padding.Right) / 3, rect.Height)
