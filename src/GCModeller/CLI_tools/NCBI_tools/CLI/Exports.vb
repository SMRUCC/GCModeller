#Region "Microsoft.VisualBasic::be7a0509173a8544c911624fb594e769, ..\GCModeller\CLI_tools\NCBI_tools\CLI\Exports.vb"
    ...
    Public Function FilterExports(args As CommandLine) As Integer
        ...
        For Each fa In New StreamIterator([in]).ReadStream
            ...
            If gi2taxid.ContainsKey(gi) Then
                ...
                Dim name As String = fa.Attributes.ElementAtOrDefault(4, "").Trim
