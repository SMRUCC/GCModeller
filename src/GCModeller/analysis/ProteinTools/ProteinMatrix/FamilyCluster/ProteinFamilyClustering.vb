#Region "Microsoft.VisualBasic::fe04db5d21f4057e7395d6889926cff1, analysis\ProteinTools\ProteinMatrix\FamilyCluster\ProteinFamilyClustering.vb"
    ...
    '   Total Lines: 318
    '    Code Lines: 202 (63.52%)
    ' Comment Lines: 72 (22.64%)
    '    - Xml Docs: 84.72%
    ' 
    '   Blank Lines: 44 (13.84%)
    '     File Size: 14.86 KB


    '     Class ProteinFamilyClustering
    ' 
    '         Properties: k, kmerSortMode, knnK, similarityCutoff, svdDims
    '                     topN
    ' 
    '         Function: BuildEdgeList, BuildFamilies, BuildTfidf, LoadSequences, LouvainPartition
    '                   Run, RunStreaming, ToSparseMatrix
    ' 
    ' 
    ' /********************************************************************************/
