#Region "Microsoft.VisualBasic::3a02a0a6868c0c47fbabc0d324278d81, analysis\ProteinTools\ProteinMatrix\FamilyCluster\StreamingClustering.vb"
    ...
    '   Total Lines: 250
    '    Code Lines: 165 (66.00%)
    ' Comment Lines: 36 (14.40%)
    '    - Xml Docs: 44.44%
    ' 
    '   Blank Lines: 49 (19.60%)
    '     File Size: 11.94 KB


    '     Class StreamingClustering
    ' 
    '         Properties: blockSize, k, kmerSortMode, knnK, resumeIfExists
    '                     svdDims, topN, workDir
    ' 
    '         Constructor: (+1 Overloads) Sub New
    ' 
    '         Function: LoadFamilySequences, Pass1BuildVocabulary, RunFamilyMsa, RunStreaming
    ' 
    '         Sub: BucketSequencesByFamily, Pass1WriteVectors
    ' 
    ' 
    ' /********************************************************************************/
