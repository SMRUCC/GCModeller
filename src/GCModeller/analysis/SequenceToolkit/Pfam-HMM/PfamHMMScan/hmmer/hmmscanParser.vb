#Region "Microsoft.VisualBasic::9d5e79db10f857ae781ea891a708ffda, analysis\SequenceToolkit\Pfam-HMM\PfamHMMScan\hmmer\hmmscanParser.vb"
    ...
    '     Module hmmscanParser
    ' 
    '         Function: (+2 Overloads) __alignmentParser, FieldParser, HitParser, LoadDoc, (+2 Overloads) QueryParser
    ' 
    ' 
    ' /********************************************************************************/
