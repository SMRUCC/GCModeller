#Region "Microsoft.VisualBasic::4f4937f34d022f633aeeb9e58af7e6b6, analysis\SequenceToolkit\Pfam-HMM\PfamHMMScan\InterPro\Family.vb"
    ...
    ' 
    '         Function: BuildFamilies, CreateObject, ToString
    ' 
    ' 
    ' /********************************************************************************/
...
Namespace InterPro
    ...
    Public Class Family
        ...
        Public Shared Function BuildFamilies(DbXml As interprodb) As IEnumerable(Of Family)
            Dim dict = DbXml.interpro.ToDictionary(Function(x) x.id)

            Return From interpro
                   In dict.AsParallel
                   Where String.Equals(interpro.Value.type, "family", StringComparison.OrdinalIgnoreCase)
                   Select Family.CreateObject(interpro.Value, dict)
        End Function
    End Class
End Namespace
