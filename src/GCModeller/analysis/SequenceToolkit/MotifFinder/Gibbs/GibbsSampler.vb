...
Namespace edu.illinois.finders
    ...
    Public Class GibbsSampler
        ...
        ''' <paramname="fileName"> path of fa file </param>
        ...
        ''' <paramname="maxIterations">, maximum number of times to iterate in a Gibbs Sample </param>
        ''' <paramname="numSamples">, number of times to Gibbs Sample </param>
        ''' <paramname="r">, object to provide randomness </param>
        ...
        ''' <paramname="maxIterations">, maximum number of iterations sampling may take </param>
        ...
        ''' <paramname="S">, sequenceCount sequences </param>
        ...
        ''' <paramname="S">, the sequences other than z </param>
        ''' <paramname="A">, the sites for the sequences other than z </param>
        ...
        ''' <paramname="S">, sequences </param>
        ''' <paramname="A">, sites </param>
        ...
        ''' <paramname="z">, sequence we are iterating through </param>
        ...
        ''' <paramname="q_ij">, motif weight matrix </param>
        ''' <paramname="z">, string of characters </param>
        ''' <paramname="x">, index of site in z </param>
        ''' <paramname="P">, background frequencies </param>
        ...
        ''' <paramname="A">, log probabilities </param>
        ...
        ''' <paramname="weightDistribution">, sequenceCount smoothed log probabilities </param>
        ...
        ''' <paramname="r">, random object </param>
