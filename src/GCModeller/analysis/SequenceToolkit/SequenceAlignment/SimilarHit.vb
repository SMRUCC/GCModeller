...
Public Class SimilarHit : Implements Enumeration(Of NamedValue(Of Double))
    ...
    Public Iterator Function GenericEnumerator() As IEnumerator(Of NamedValue(Of Double)) Implements Enumeration(Of NamedValue(Of Double)).GenericEnumerator
        For Each member In Similar
            Yield New NamedValue(Of Double)(member.Key, member.Value)
        Next
    End Function
End Class
