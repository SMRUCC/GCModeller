#Region "Microsoft.VisualBasic::b346a2941b199bc851436a385f17537d, analysis\SequenceToolkit\SequenceAlignment\siRNAHit\siRNAHit.vb"
...
'     Class siRNAHit
' 
'         Properties: Alignment, EndSite, Expectation, GapCount, Length
'                     miRNA, MismatchCount, Source, StartSite, Target
'                     TranslationInhibition, WobbleCount
' 
'         Function: FromHSP, ToString
' 
'     Interface IAccessibilityEvaluator
' 
'         Function: UPE
' 
'     Class DisabledAccessibility
' 
'         Function: UPE
' 
'     Interface miRNAMapper
' 
'         Function: Run
' 
' 
...
Namespace siRNAHit
    ...
    Public Class siRNAHit
        ...
        Public Shared Function FromHSP(mirna As String, hsp As LocalHSPMatch(Of Char), source As String) As siRNAHit
