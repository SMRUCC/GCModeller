#Region "Microsoft.VisualBasic::1c8ecbc0b99a4798d7afa8fa4cde8bdc, analysis\SequenceToolkit\SequenceAlignment\SmithWaterman\Extension\Extensions.vb"
...
Namespace BestLocalAlignment
    ...
    Public Module Coverage
        ...
        <Extension>
        Public Function QueryLength(source As IEnumerable(Of HSP)) As Integer
        ...
        <Extension>
        Public Function SubjectLength(source As IEnumerable(Of HSP)) As Integer
            Dim nlst As Coordinate() = source _
                .Select(Function(x)
