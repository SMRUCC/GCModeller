#Region "Microsoft.VisualBasic::8e4100ccf329a1368900f78191d80322, analysis\OperonMapper\OperonPrediction\FeatureScores.vb"
    ...
    '     Class FeatureScores
    ' 
    '         Properties: DistanceGroup, downstreamID, GOSimilarity, IntergenicDistance, LengthRatio
    '                     MetabolicScore, Motifs, NeighborhoodConservation, PhylogeneticDistance, PhylogeneticDistanceShannon
    '                     upstreamID
    ' 
    ' 
    ' /********************************************************************************/
