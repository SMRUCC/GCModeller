#Region "Microsoft.VisualBasic::5c7df293acfa991c7020929aeae4ff90, analysis\Microarray\test\SEM\DataGenerator.vb"
    ...
    ' Comment Lines: 62 (26.27%)
    '    - Xml Docs: 41.94%
    ' 
    '   Blank Lines: 25 (10.59%)
    '     File Size: 10.19 KB


    ' Module DataGenerator
    ' 
    '     Function: Gaussian, GenerateDemoData, GetInnerPaths, GetLatentDefinitions, GetSEMDataSubset
    '               GetSEMPaths, GetSEMPathsOnSubset, GetSEMVarNames
    ' 
    '     Sub: PrintDataSummary
    ' 
    ' /********************************************************************************/
