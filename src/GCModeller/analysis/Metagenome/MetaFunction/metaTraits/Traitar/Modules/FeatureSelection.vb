#Region "Microsoft.VisualBasic::6e0043625778fb9d6fe960a501e46ca9, analysis\Metagenome\MetaFunction\metaTraits\Traitar\Modules\FeatureSelection.vb"
    ...
    '   Total Lines: 308
    '    Code Lines: 178 (57.79%)
    ' Comment Lines: 77 (25.00%)
    '    - Xml Docs: 54.55%
    ' 
    ...
    '         Function: GenerateReport, LoadKeyFeaturesFromFile, RankByPearsonCorrelation, SelectKeyFeatures
    '         Class KeyFeature
    ' 
    '             Properties: AvgPositiveWeight, Description, IsKeyFeature, PearsonCorrelation, PfamId
    '                         PositiveWeightCount
    ' 
    ' 
    ' 
