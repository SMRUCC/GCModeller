#Region "Microsoft.VisualBasic::6850547914d0e36176136c0e80db00be, analysis\Metagenome\MetaFunction\metaTraits\Traitar\Modules\PhylogenyAncestral.vb"
    ...
    '   Total Lines: 453
    '    Code Lines: 273 (60.26%)
    ' Comment Lines: 123 (27.15%)
    '    - Xml Docs: 56.10%
    ' 
    '   Blank Lines: 57 (12.58%)
    '     File Size: 20.10 KB


    '     Class PhylogenyAncestral
    ' 
    '         Function: ComputeTransitionMatrix, GammaInverseCDF, GammaSample, NormalInverseCDF, PruneTree
    '                   PruneTreeRecursive
    ' 
    '         Sub: ComputeGainLossForFeature, ComputeGainLossProbabilities, ComputePartialLikelihoods, ComputePosteriorProbabilities, InferAncestralStates
    '              InferSingleFeatureAncestral
    ' 
    '     Module PhyloTreeNodeExtensions
    ' 
    '         Function: Clone
    ' 
    ' 
