#Region "Microsoft.VisualBasic::7bf54809117bc7c3141ddc2143c3da99, analysis\Metagenome\Metagenome\DataAnalysis\ZetaDiversity.vb"
    ...
    '   Total Lines: 1387
    '    Code Lines: 673 (48.52%)
    ' Comment Lines: 495 (35.69%)
    '    - Xml Docs: 70.71%
    ' 
    '   Blank Lines: 219 (15.79%)
    '     File Size: 60.30 KB


    '     Module ZetaDiversityAnalysis
    ' 
    '         Function: Analyze, BinomialRandom, BuildPresenceAbsenceMatrix, Combination, ComputeBetaDiversity
    '                   ComputeCommonnessIndex, ComputeNormalizedZeta, ComputeOccupancies, ComputeRarityIndex, ComputeReturnRates
    '                   ComputeZeta, ComputeZetaForSites, ComputeZetaLogSpace, ComputeZetaRatios, ComputeZetaSeries
    '                   FitExponential, FitLinear, FitPowerLaw, FormatResult, GetAllSamples
    '                   LinearRegression, LogCombination, LogSumExp, PermutationTest, RandomSample
    '                   SelectBestFitByAICc, SelectBestFitByR2
    ' 
    '     Class ZetaFitResult
    ' 
    '         Properties: AIC, AICc, BIC, IsValid, ModelName
    '                     ParameterA, ParameterB, PredictedValues, R2, SSE
    ' 
    '     Class ZetaNullModelResult
    ' 
    '         Properties: NullMeanZeta, NullStdZeta, NumPermutations, ObservedZeta, PValues
    '                     StandardizedEffectSizes
    ' 
    '     Class ZetaAnalysisResult
    ' 
    '         Properties: BestFitAICc, BestFitModel, BestFitModelByR2, BestFitR2, BetaDiversity
    '                     CommonnessIndex, ExponentialFit, LinearFit, MaxOrder, NormalizedZeta
    '                     NullModelResult, NumberOfSites, NumberOfSpecies, PowerLawFit, RarityIndex
    '                     ReturnRates, ZetaRatios, ZetaSeries
    ' 
    ' 
    ' /********************************************************************************/
