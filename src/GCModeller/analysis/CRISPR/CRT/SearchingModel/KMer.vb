#Region "Microsoft.VisualBasic::b1c52674dfc71a21cbbcf098bba45f6d, ..\GCModeller\analysis\CRISPR\CRT\SearchingModel\KMer.vb"
    ...
    Public Module KMer
        ...
        Public Function HasSimilarlySizedSpacers(CandidateCRISPR As CRISPR, SpacerToSpacerLengthOffset As Integer, spacerToRepeatLengthOffset As Integer) As Boolean
            ...
            For i As Integer = 0 To CandidateCRISPR.NumberOfSpacers() - 1
                ...
                If Math.Abs(currSpacerLength - InitialSpacerLength) > SpacerToSpacerLengthOffset Then
                    Return False
                End If

                'checks that each spacer is of similar size to the repeats
                If Math.Abs(currSpacerLength - repeatLength) > spacerToRepeatLengthOffset Then
                    Return False
                End If
            Next
