...
Namespace WGCNA
    ...
    <PackageAttribute("WGCNA", Cites:="Langfelder, P. and S. Horvath (2008). ""WGCNA: an R package For weighted correlation network analysis."" BMC Bioinformatics 9: 559.
...
Principal Component Analysis",
    ...
    Public Module API
        ...
        ''' </summary>
        ''' <param name="dataExpr">The text encoding of this document should be ASCII, or the data reading in the R will be failed!(转录组数据的csv文件的位置，请注意！，数据文件都必须是ASCII编码的)</param>
        ''' <param name="GeneIdLabel">使用这个参数来修改Id映射</param>
        ''' <returns></returns>
        ''' 
        <ExportAPI("WGCNA.Analysis", Info:="Applying the WGCNA analysis on your transcriptome data.")>
