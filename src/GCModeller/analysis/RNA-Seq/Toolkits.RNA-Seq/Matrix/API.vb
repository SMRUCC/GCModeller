#Region "Microsoft.VisualBasic::78c25691cc022cfe7ad3bd6e71030d71, ..\GCModeller\analysis\RNA-Seq\Toolkits.RNA-Seq\Matrix\API.vb"
...
Namespace dataExprMAT
    ...
    Public Module API
        ...
        <ExportAPI("RPKM.Log2")>
        Public Function Log2Values([operator] As MatrixFrame, profile As String()()) As DocumentFormat.Csv.DocumentStream.File
