#Region "Microsoft.VisualBasic::101c7e8f6d4a1290e4ba620524c3b079, data\Rhea\TextParser.vb"
...
Public Module TextParser
    ...
    <Extension>
    Public Iterator Function ParseCompounds(lines As IEnumerable(Of String)) As IEnumerable(Of CompoundSpecies)
        For Each block As String() In lines.Split("///")
            Dim list As Dictionary(Of String, String) = block.ParseList
            Dim obj As New CompoundSpecies With {
                .entry = list!ENTRY,
                .name = list!NAME,
