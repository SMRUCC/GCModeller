#Region "Microsoft.VisualBasic::d48dbec9004f351e807c19cfc7e6a74f, ..\GCModeller\data\ExternalDBSource\Regtransbase\StructureObjects\RegulatoryElements.vb"
...
Namespace Regtransbase.StructureObjects
    ...
    <TableName("regulators")> Public Class Regulator : Inherits RegulatoryElement
        Implements LANS.SystemsBiology.Assembly.SequenceModel.FASTA.FastaExportMethods.FsaObject

        <FastaExportMethods.FsaAttributeItem(0)> <DatabaseField("regulator_guid")> Public Overrides Property Guid As Integer
        ''' <summary>
        ...
        ''' </summary>
        ''' <remarks></remarks>
        <FastaExportMethods.FsaAttributeItem(3, precursor:="consensus")> <DatabaseField("consensus")> Public Property Consensus As String
        ''' <summary>
        ''' family: regulator family
        ''' </summary>
        ''' <remarks></remarks>
        <FastaExportMethods.FsaAttributeItem(2)> <DatabaseField("family")> Public Property Family As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        <FastaExportMethods.FsaAttributeItem(1)> <DatabaseField("name")> Public Overrides Property Name As String

        Public Overrides Function ToString() As String
            Return String.Format("{0} (Family:={1})", Name, Family)
        End Function

        Public Shared Function ExportFasta(regulator As Regulator, Genes As Regtransbase.StructureObjects.Gene(), Optional TryAutoFixed As Boolean = False) As LANS.SystemsBiology.Assembly.SequenceModel.FASTA.FastaObject
            If regulator.GeneGuid Is Nothing OrElse regulator.GeneGuid = -1 Then
                Return Nothing
            Else
                Dim Fsa As LANS.SystemsBiology.Assembly.SequenceModel.FASTA.FastaObject = New Assembly.SequenceModel.FASTA.FastaObject
                Dim Gene = (From g In Genes Where regulator.GeneGuid = g.Guid Select g).First
                If LANS.SystemsBiology.Assembly.SequenceModel.FASTA.FastaObject.Is_ProteinSequence(Gene) Then
                ...
                Else
                    ...
                    Else
                        Fsa.Attributes = New String() {"regulator", regulator.Guid, regulator.Family, String.Format("TypeGuid:={0}", regulator.RegulatorTypeGuid), regulator.Name, regulator.Consensus}
                    End If
                    Fsa.SequenceData = LANS.SystemsBiology.Assembly.SequenceModel.Polypeptides.Polypeptides.Translate(Fsa.SequenceData)
                End If
                Return Fsa
            End If
        End Function
        ...
        Public Function TryAssignSequence(Genes As Regtransbase.StructureObjects.Gene()) As Regulator
            If Not (Me.GeneGuid Is Nothing OrElse Me.GeneGuid = -1) Then
                ...
                Else
                    ...
                    _SequenceData = LANS.SystemsBiology.Assembly.SequenceModel.Polypeptides.Polypeptides.Translate(_SequenceData)
                End If
            End If
        ...
        Public Function GetSequenceData() As String Implements Assembly.SequenceModel.FASTA.FastaExportMethods.FsaObject.GetSequenceData
    ...
    <TableName("sites")> Public Class Sites : Inherits RegulatoryElement
        ...
        Public Shared Function ExportFasta(site As Sites, Optional TryAutoFixed As Boolean = False) As LANS.SystemsBiology.Assembly.SequenceModel.FASTA.FastaObject
    ...
    Public Class Gene : Inherits RegulatoryElement
        ...
        ''' </summary>
        ''' <remarks></remarks>
        <DatabaseField("signature")> Public Property signature As String Implements Assembly.SequenceModel.ISequenceModel.ISequence.SequenceData
        ''' <summary>
