...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `quanttypewidquanttypemapwid` (`QuantitationTypeWID`, `QuantitationTypeMapWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `quanttypewidquanttypemapwid` (`QuantitationTypeWID`, `QuantitationTypeMapWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `quanttypewidquanttypemapwid` (`QuantitationTypeWID`, `QuantitationTypeMapWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `quanttypewidquanttypemapwid` (`QuantitationTypeWID`, `QuantitationTypeMapWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `quanttypewidquanttypemapwid` WHERE `QuantitationTypeWID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `quanttypewidquanttypemapwid` SET `QuantitationTypeWID`='{0}', `QuantitationTypeMapWID`='{1}' WHERE `QuantitationTypeWID` = '{2}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, QuantitationTypeWID, QuantitationTypeMapWID)
        Else
        Return String.Format(INSERT_SQL, QuantitationTypeWID, QuantitationTypeMapWID)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, QuantitationTypeWID, QuantitationTypeMapWID)
        Else
        Return String.Format(REPLACE_SQL, QuantitationTypeWID, QuantitationTypeMapWID)
        End If
    End Function
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As quanttypewidquanttypemapwid
                         Return DirectCast(MyClass.MemberwiseClone, quanttypewidquanttypemapwid)
                     End Function
End Class
