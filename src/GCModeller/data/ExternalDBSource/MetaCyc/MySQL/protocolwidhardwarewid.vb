...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `protocolwidhardwarewid` (`ProtocolWID`, `HardwareWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `protocolwidhardwarewid` (`ProtocolWID`, `HardwareWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `protocolwidhardwarewid` (`ProtocolWID`, `HardwareWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `protocolwidhardwarewid` (`ProtocolWID`, `HardwareWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `protocolwidhardwarewid` WHERE `ProtocolWID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `protocolwidhardwarewid` SET `ProtocolWID`='{0}', `HardwareWID`='{1}' WHERE `ProtocolWID` = '{2}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, ProtocolWID, HardwareWID)
        Else
        Return String.Format(INSERT_SQL, ProtocolWID, HardwareWID)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, ProtocolWID, HardwareWID)
        Else
        Return String.Format(REPLACE_SQL, ProtocolWID, HardwareWID)
        End If
    End Function
