#Region "Microsoft.VisualBasic::2bd533f3d0bec0fa63cd7a3d865a7183, data\ExternalDBSource\MetaCyc\MySQL\featuredimensionwidfeaturewid.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `featuredimensionwidfeaturewid` (`FeatureDimensionWID`, `FeatureWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `featuredimensionwidfeaturewid` (`FeatureDimensionWID`, `FeatureWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `featuredimensionwidfeaturewid` (`FeatureDimensionWID`, `FeatureWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `featuredimensionwidfeaturewid` (`FeatureDimensionWID`, `FeatureWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `featuredimensionwidfeaturewid` WHERE `FeatureDimensionWID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `featuredimensionwidfeaturewid` SET `FeatureDimensionWID`='{0}', `FeatureWID`='{1}' WHERE `FeatureDimensionWID` = '{2}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, FeatureDimensionWID, FeatureWID)
        Else
        Return String.Format(INSERT_SQL, FeatureDimensionWID, FeatureWID)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, FeatureDimensionWID, FeatureWID)
        Else
        Return String.Format(REPLACE_SQL, FeatureDimensionWID, FeatureWID)
        End If
    End Function
