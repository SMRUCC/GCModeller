#Region "Microsoft.VisualBasic::58e211bf63b11a0e928c3981b8a6af2b, data\ExternalDBSource\MetaCyc\MySQL\arraydesignwidcompositegrpwid.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `arraydesignwidcompositegrpwid` (`ArrayDesignWID`, `CompositeGroupWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `arraydesignwidcompositegrpwid` (`ArrayDesignWID`, `CompositeGroupWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `arraydesignwidcompositegrpwid` (`ArrayDesignWID`, `CompositeGroupWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `arraydesignwidcompositegrpwid` (`ArrayDesignWID`, `CompositeGroupWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `arraydesignwidcompositegrpwid` WHERE `ArrayDesignWID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `arraydesignwidcompositegrpwid` SET `ArrayDesignWID`='{0}', `CompositeGroupWID`='{1}' WHERE `ArrayDesignWID` = '{2}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, ArrayDesignWID, CompositeGroupWID)
        Else
        Return String.Format(INSERT_SQL, ArrayDesignWID, CompositeGroupWID)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, ArrayDesignWID, CompositeGroupWID)
        Else
        Return String.Format(REPLACE_SQL, ArrayDesignWID, CompositeGroupWID)
        End If
    End Function
