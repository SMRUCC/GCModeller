#Region "Microsoft.VisualBasic::51b6692b54aebac2befa8eaf3976bfe1, data\ExternalDBSource\MetaCyc\MySQL\designelementmapping.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `designelementmapping` (`WID`, `DataSetWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `designelementmapping` (`WID`, `DataSetWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `designelementmapping` (`WID`, `DataSetWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `designelementmapping` (`WID`, `DataSetWID`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `designelementmapping` WHERE `WID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `designelementmapping` SET `WID`='{0}', `DataSetWID`='{1}' WHERE `WID` = '{2}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As designelementmapping
                         Return DirectCast(MyClass.MemberwiseClone, designelementmapping)
                     End Function
End Class
