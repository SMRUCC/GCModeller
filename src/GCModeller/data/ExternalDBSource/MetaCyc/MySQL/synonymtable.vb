...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `synonymtable` (`OtherWID`, `Syn`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `synonymtable` (`OtherWID`, `Syn`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `synonymtable` (`OtherWID`, `Syn`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `synonymtable` (`OtherWID`, `Syn`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `synonymtable` WHERE `OtherWID`='{0}' and `Syn`='{1}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `synonymtable` SET `OtherWID`='{0}', `Syn`='{1}' WHERE `OtherWID`='{2}' and `Syn`='{3}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, OtherWID, Syn)
        Else
        Return String.Format(INSERT_SQL, OtherWID, Syn)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, OtherWID, Syn)
        Else
        Return String.Format(REPLACE_SQL, OtherWID, Syn)
        End If
    End Function
