#Region "Microsoft.VisualBasic::85ecafe7d82c8df9516621166019d515, ..\GCModeller\data\ExternalDBSource\MetaCyc\bio_warehouse\experimentwidcontactwid.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("experimentwidcontactwid", Database:="warehouse")>
Public Class experimentwidcontactwid: Inherits Oracle.LinuxCompatibility.MySQL.SQLTable
...
#Region "Interface SQL"
    Private Shared ReadOnly INSERT_SQL As String = <SQL>INSERT INTO `experimentwidcontactwid` (`ExperimentWID`, `ContactWID`) VALUES ('{0}', '{1}');</SQL>
    Private Shared ReadOnly REPLACE_SQL As String = <SQL>REPLACE INTO `experimentwidcontactwid` (`ExperimentWID`, `ContactWID`) VALUES ('{0}', '{1}');</SQL>
    Private Shared ReadOnly DELETE_SQL As String = <SQL>DELETE FROM `experimentwidcontactwid` WHERE `ExperimentWID` = '{0}';</SQL>
    Private Shared ReadOnly UPDATE_SQL As String = <SQL>UPDATE `experimentwidcontactwid` SET `ExperimentWID`='{0}', `ContactWID`='{1}' WHERE `ExperimentWID` = '{2}';</SQL>
#End Region
