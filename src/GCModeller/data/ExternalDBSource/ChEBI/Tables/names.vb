#Region "Microsoft.VisualBasic::c076bed24e208a38a698b1531d75f52a, data\ExternalDBSource\ChEBI\Tables\names.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `names` (`id`, `compound_id`, `name`, `type`, `source`, `adapted`, `language`) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `names` (`id`, `compound_id`, `name`, `type`, `source`, `adapted`, `language`) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `names` (`id`, `compound_id`, `name`, `type`, `source`, `adapted`, `language`) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `names` (`id`, `compound_id`, `name`, `type`, `source`, `adapted`, `language`) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `names` WHERE `id` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `names` SET `id`='{0}', `compound_id`='{1}', `name`='{2}', `type`='{3}', `source`='{4}', `adapted`='{5}', `language`='{6}' WHERE `id` = '{7}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, id, compound_id, name, type, source, adapted, language)
        Else
        Return String.Format(INSERT_SQL, id, compound_id, name, type, source, adapted, language)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, id, compound_id, name, type, source, adapted, language)
        Else
        Return String.Format(REPLACE_SQL, id, compound_id, name, type, source, adapted, language)
        End If
    End Function
