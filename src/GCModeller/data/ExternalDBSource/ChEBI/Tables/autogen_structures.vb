...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `autogen_structures` (`id`, `structure_id`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `autogen_structures` (`id`, `structure_id`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `autogen_structures` (`id`, `structure_id`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `autogen_structures` (`id`, `structure_id`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `autogen_structures` WHERE `id` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `autogen_structures` SET `id`='{0}', `structure_id`='{1}' WHERE `id` = '{2}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As autogen_structures
                         Return DirectCast(MyClass.MemberwiseClone, autogen_structures)
                     End Function
End Class
