#Region "Microsoft.VisualBasic::2375640e46f4ca06190d7753ef630555, ..\GCModeller\data\ExternalDBSource\WebServices\Service References\NCBI.eUtils\Reference.vb"
...
Namespace NCBI.eUtils
    ...
    Partial Public Class IdLinkSetType
        ...
        '''<remarks/>
        <XmlElementAttribute("LinkInfo", Order:=1)>  _
    ...
    Partial Public Class IdCheckListType
        ...
        '''<remarks/>
        <XmlElementAttribute("Id", GetType(IdType), Order:=0),  _
    ...
    Partial Public Class FirstCharsType
        ...
        '''<remarks/>
        <XmlElementAttribute("FirstChar", Order:=0)>  _
    ...
    Partial Public Class ObjUrlType
        ...
        '''<remarks/>
        <XmlElementAttribute("SubjectType", Order:=3)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute("Category", Order:=4)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute("Attribute", Order:=5)>  _
    ...
    Partial Public Class IdUrlSetType
        ...
        '''<remarks/>
        <XmlElementAttribute("Info", GetType(String), Order:=1),  _
    ...
    Partial Public Class IdUrlListType
        ...
        '''<remarks/>
        <XmlElementAttribute("FirstChars", GetType(FirstCharsType), Order:=0),  _
    ...
    Partial Public Class LinkSetDbType
        ...
        '''<remarks/>
        <XmlElementAttribute("Link", Order:=2)>  _
    ...
    Partial Public Class LinkSetType
        ...
        '''<remarks/>
        <XmlElementAttribute("LinkSetDb", Order:=2)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute("LinkSetDbHistory", Order:=3)>  _
    ...
    Partial Public Class ItemType
        ...
        '''<remarks/>
        <XmlElementAttribute("Item", Order:=0)>  _
    ...
    Partial Public Class DocSumType
        ...
        '''<remarks/>
        <XmlElementAttribute("Item", Order:=1)>  _
        Public Property Item() As ItemType()
            Get
                Return Me.itemField
            End Get
    ...
    Partial Public Class WarningListType
        ...
        '''<remarks/>
        <XmlElementAttribute("PhraseIgnored", Order:=0)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute("QuotedPhraseNotFound", Order:=1)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute("OutputMessage", Order:=2)>  _
    ...
    Partial Public Class ErrorListType
        ...
        '''<remarks/>
        <XmlElementAttribute("PhraseNotFound", Order:=0)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute("FieldNotFound", Order:=1)>  _
    ...
    Partial Public Class FieldType
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=10)>  _
    ...
    Partial Public Class DbListType
        ...
        '''<remarks/>
        <XmlElementAttribute("DbName", Order:=0)>  _
    ...
    Partial Public Class eGQueryResultType
        ...
        '''<remarks/>
        <XmlElementAttribute("ResultItem", Order:=1)>  _
    ...
    Partial Public Class eSearchRequest
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=11)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=12)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=13)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=14)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=15)>  _
    ...
    Partial Public Class eSummaryResult
        ...
        '''<remarks/>
        <XmlElementAttribute("DocSum", Order:=1)>  _
    ...
    Partial Public Class eLinkRequest
        ...
        '''<remarks/>
        <XmlElementAttribute("id", Order:=1)>  _
        Public Property id() As String()
            Get
                Return Me.idField
            End Get
    ...
    Partial Public Class eLinkResult
        ...
        '''<remarks/>
        <XmlElementAttribute("LinkSet", Order:=0)>  _
    ...
    Partial Public Class SpelledQuery
        ...
        '''<remarks/>
        <XmlElementAttribute("Original", GetType(String), Order:=0),  _
        ...
        '''<remarks/>
        <XmlElementAttribute("ItemsElementName", Order:=1),  _
