#Region "Microsoft.VisualBasic::42715a14bc0fae26bf37197d3f983de0, ..\GCModeller\data\ExternalDBSource\WebServices\Service References\WSDbfetchDoclitServerServices\Reference.vb"
...
Namespace WSDbfetchDoclitServerServices
    ...
    '''<remarks/>
    <XmlIncludeAttribute(GetType(DbfNoEntryFoundException)),  _
    ...
    Partial Public Class StyleInfo
        ...
        '''<remarks/>
        <XmlElementAttribute(IsNullable:=true, Order:=0)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(IsNullable:=true, Order:=1)>  _
    ...
    Partial Public Class FormatInfo
        ...
        '''<remarks/>
        <XmlArrayAttribute(IsNullable:=true, Order:=0),  _
        ...
        '''<remarks/>
        <XmlArrayAttribute(IsNullable:=true, Order:=1),  _
        ...
        '''<remarks/>
        <XmlArrayAttribute(IsNullable:=true, Order:=3),  _
        ...
        '''<remarks/>
        <XmlArrayAttribute(IsNullable:=true, Order:=4),  _
    ...
    Partial Public Class ExampleIdentifiersInfo
        ...
        '''<remarks/>
        <XmlArrayAttribute(IsNullable:=true, Order:=2),  _
    ...
    Partial Public Class DatabaseInfo
        ...
        '''<remarks/>
        <XmlElementAttribute(IsNullable:=true, Order:=3)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(IsNullable:=true, Order:=4)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(IsNullable:=true, Order:=5)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(IsNullable:=true, Order:=6)>  _
        ...
        '''<remarks/>
        <XmlArrayAttribute(IsNullable:=true, Order:=7),  _
        ...
        '''<remarks/>
        <XmlElementAttribute(IsNullable:=true, Order:=8)>  _
        Public Property href() As String
            Get
                Return Me.hrefField
            End Get
        ...
        '''<remarks/>
        <XmlElementAttribute(IsNullable:=true, Order:=9)>  _
        Public Property name() As String
            Get
                Return Me.nameField
            End Get
