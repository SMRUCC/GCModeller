#Region "Microsoft.VisualBasic::f9d3e539e87e1a527eccfa8abd713c6e, ..\GCModeller\data\ExternalDBSource\WebServices\Service References\NCBI\Reference.vb"
...
Namespace NCBI
    ...
    Partial Public Class DataBlobType
        ...
        '''<remarks/>
        <XmlElementAttribute(DataType:="base64Binary", Order:=0)>  _
    ...
    Partial Public Class AssayDescriptionType
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=16)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=17)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=18)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=19)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=20)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=21)>  _
        ...
        '''<remarks/>
        <XmlElementAttribute(Order:=22)>  _
