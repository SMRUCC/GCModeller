#Region "Microsoft.VisualBasic::19759cfd62b3fddcd8a899712654cb1e, ..\GCModeller\data\ExternalDBSource\WebServices\EBI\IPRScanClient.vb"
...
'' $Id: IPRScanClient.vb 2523 2013-02-06 13:51:28Z hpm $
'' ======================================================================
'' 
...
'Imports System
'Imports System.IO
'Imports LANS.SystemsBiology.DatabaseServices.WebServices.EbiWS.IPRScanWs ' "Web Reference" or wsdl.exe generated stubs.
...
'                Return _srvProxy
'            End Get
'            Set( value As JDispatcherService)
'                _srvProxy = value
'            End Set
'        End Property
...
'		Public Function GetParamDetail( paramName As String) As wsParameterDetails 
...
'		' Submit a job to the service.
'		Public Function RunApp( email As String,  title As String, input As InputParameters) As String
...
'		Public Function GetResultTypes( jobId As String) As wsResultType()
