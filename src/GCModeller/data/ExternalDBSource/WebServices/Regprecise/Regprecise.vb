#Region "Microsoft.VisualBasic::99c7e7ce844de58069c41550a8ec5e0a, ..\GCModeller\data\ExternalDBSource\WebServices\Regprecise\Regprecise.vb"
...
Imports LANS.SystemsBiology.DatabaseServices.Regprecise.WebServices.JSONLDM
...
Namespace Regprecise
    ...
    <PackageNamespace("Regprecise.WebServices.API",
...
<li>taxonomyId - NCBI taxonomy id</li>")> LANS.SystemsBiology.DatabaseServices.Regprecise.WebServices.JSONLDM.genome()
            Call "Downloading bacterial genomes entry data from: http://regprecise.lbl.gov/Services/rest/genomes".__DEBUG_ECHO
            Dim retValue As DatabaseServices.Regprecise.WebServices.JSONLDM.genome() = Retrieves(Of DatabaseServices.Regprecise.WebServices.JSONLDM.genome)("http://regprecise.lbl.gov/Services/rest/genomes")
...
<li>className - name of collection class</li>")> LANS.SystemsBiology.DatabaseServices.Regprecise.WebServices.JSONLDM.regulogCollection()
...
")> LANS.SystemsBiology.DatabaseServices.Regprecise.WebServices.JSONLDM.regulog()
...
")> LANS.SystemsBiology.DatabaseServices.Regprecise.WebServices.JSONLDM.regulon()
...
")> LANS.SystemsBiology.DatabaseServices.Regprecise.WebServices.JSONLDM.regulator()
...
<li>rnaSiteCount - number of RNA regulatory sites in collection</li>")> LANS.SystemsBiology.DatabaseServices.Regprecise.WebServices.JSONLDM.regulogCollectionStat()
...
<li>foundObjName - found object name (or locusTag)</li>")> LANS.SystemsBiology.DatabaseServices.Regprecise.WebServices.JSONLDM.regulonRef()
...
<li>rnaSiteCount - total number of RNA regulatory sites in genome</li>")> genomeStat()
        ...
        Public Function wGetDownload(<Parameter("DIR.EXPORT",
            ...
            Dim genomes As DatabaseServices.Regprecise.WebServices.JSONLDM.genome()
        ...
        Public Function wGetDownload(genomes As IEnumerable(Of JSONLDM.genome),
            ...
            For Each genome As DatabaseServices.Regprecise.WebServices.JSONLDM.genome In genomes
