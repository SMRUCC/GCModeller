...
Namespace StringDB.StrPNet
    ...
    Public Class Assembler
        ...
        Private Function GetEdge(Id1 As String, Id2 As String) As StringDB.SimpleCsv.PitrNode
        ...
        Public Function Assembly(TF As String) As Pathway
            Dim STrP As Pathway = New Pathway With {.TF = TF, .Effectors = GetEffectors(TF)}
        ...
        Private Function GetEffectors(TF As String) As String()
            Dim ChunkBuffer = (From item In Me.TF.GetItems(TF) Let result As String() = item.Effectors Where Not result.IsNullOrEmpty Select result).ToArray
        ...
        Public Function GetInteractions(Interactor As String) As StringDB.SimpleCsv.PitrNode()
