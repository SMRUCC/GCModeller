...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("tf_matrix", Database:="regulondb_7_5")>
Public Class tf_matrix: Inherits Oracle.LinuxCompatibility.MySQL.SQLTable
