#Region "Microsoft.VisualBasic::94c3a81115fad52d04b6283d8dfd584e, G:/GCModeller/src/GCModeller/data/RegulonDatabase//RegulonDB/MySQL/gu_group_link.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `gu_group_link` (`gu_id`, `group_id`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `gu_group_link` (`gu_id`, `group_id`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `gu_group_link` (`gu_id`, `group_id`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `gu_group_link` (`gu_id`, `group_id`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `gu_group_link` WHERE ;</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `gu_group_link` SET `gu_id`='{0}', `group_id`='{1}' WHERE ;</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, gu_id, group_id)
        Else
        Return String.Format(INSERT_SQL, gu_id, group_id)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, gu_id, group_id)
        Else
        Return String.Format(REPLACE_SQL, gu_id, group_id)
        End If
    End Function
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As gu_group_link
                         Return DirectCast(MyClass.MemberwiseClone, gu_group_link)
                     End Function
End Class
