#Region "Microsoft.VisualBasic::22c358549a2ab05c25858b6613f08c4e, G:/GCModeller/src/GCModeller/data/RegulonDatabase//Regtransbase/MySQL/dict_exp_result_types.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `dict_exp_result_types` (`exp_result_type_guid`, `name`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `dict_exp_result_types` (`exp_result_type_guid`, `name`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `dict_exp_result_types` (`exp_result_type_guid`, `name`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `dict_exp_result_types` (`exp_result_type_guid`, `name`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `dict_exp_result_types` WHERE `exp_result_type_guid` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `dict_exp_result_types` SET `exp_result_type_guid`='{0}', `name`='{1}' WHERE `exp_result_type_guid` = '{2}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, exp_result_type_guid, name)
        Else
        Return String.Format(INSERT_SQL, exp_result_type_guid, name)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, exp_result_type_guid, name)
        Else
        Return String.Format(REPLACE_SQL, exp_result_type_guid, name)
        End If
    End Function
