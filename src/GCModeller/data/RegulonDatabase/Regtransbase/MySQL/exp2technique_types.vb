#Region "Microsoft.VisualBasic::256db5c93762790819be7eb5634338df, G:/GCModeller/src/GCModeller/data/RegulonDatabase//Regtransbase/MySQL/exp2technique_types.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `exp2technique_types` (`pkg_guid`, `art_guid`, `exp_guid`, `exp_technique_type_guid`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `exp2technique_types` (`pkg_guid`, `art_guid`, `exp_guid`, `exp_technique_type_guid`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `exp2technique_types` (`pkg_guid`, `art_guid`, `exp_guid`, `exp_technique_type_guid`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `exp2technique_types` (`pkg_guid`, `art_guid`, `exp_guid`, `exp_technique_type_guid`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `exp2technique_types` WHERE `exp_guid`='{0}' and `exp_technique_type_guid`='{1}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `exp2technique_types` SET `pkg_guid`='{0}', `art_guid`='{1}', `exp_guid`='{2}', `exp_technique_type_guid`='{3}' WHERE `exp_guid`='{4}' and `exp_technique_type_guid`='{5}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, pkg_guid, art_guid, exp_guid, exp_technique_type_guid)
        Else
        Return String.Format(INSERT_SQL, pkg_guid, art_guid, exp_guid, exp_technique_type_guid)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, pkg_guid, art_guid, exp_guid, exp_technique_type_guid)
        Else
        Return String.Format(REPLACE_SQL, pkg_guid, art_guid, exp_guid, exp_technique_type_guid)
        End If
    End Function
