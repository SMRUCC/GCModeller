...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("sites", Database:="dbregulation_update")>
Public Class sites: Inherits Oracle.LinuxCompatibility.MySQL.SQLTable
