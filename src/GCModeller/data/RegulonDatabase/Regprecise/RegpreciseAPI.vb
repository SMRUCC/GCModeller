#Region "Microsoft.VisualBasic::596dda8abfdba790e5a1ed828681b528, ..\GCModeller\data\RegulonDatabase\Regprecise\RegpreciseAPI.vb"
    ...
    Public Module RegpreciseAPI
        ...
        Public Function GenerateDatabase(DIR As String) As TranscriptionFactors
            Dim LQuery = (From File As String In FileIO.FileSystem.GetFiles(DIR, FileIO.SearchOption.SearchAllSubDirectories, "*.xml").AsParallel
                          Let Bacteria As Regprecise.BacteriaGenome = Distinct(File.LoadXml(Of DatabaseServices.Regprecise.BacteriaGenome)())
                          Select Bacteria
