#Region "Microsoft.VisualBasic::1ba8db4abf238e0c5da160dc32bdd6b0, ..\GCModeller\data\Reactome\LocalMySQL\gk_current\taxon.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("taxon", Database:="gk_current")>
Public Class taxon: Inherits Oracle.LinuxCompatibility.MySQL.SQLTable
#Region "Public Property Mapping To Database Fields"
    <DatabaseField("DB_ID"), PrimaryKey, NotNull, DataType(MySqlDbType.Int64, "10")> Public Property DB_ID As Long
    <DatabaseField("superTaxon"), DataType(MySqlDbType.Int64, "10")> Public Property superTaxon As Long
    <DatabaseField("superTaxon_class"), DataType(MySqlDbType.VarChar, "64")> Public Property superTaxon_class As String
#End Region
