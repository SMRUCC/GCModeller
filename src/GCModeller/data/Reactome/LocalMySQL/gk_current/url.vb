...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `url` (`DB_ID`, `uniformResourceLocator`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `url` (`DB_ID`, `uniformResourceLocator`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `url` (`DB_ID`, `uniformResourceLocator`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `url` (`DB_ID`, `uniformResourceLocator`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `url` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `url` SET `DB_ID`='{0}', `uniformResourceLocator`='{1}' WHERE `DB_ID` = '{2}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, uniformResourceLocator)
        Else
        Return String.Format(INSERT_SQL, DB_ID, uniformResourceLocator)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, uniformResourceLocator)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, uniformResourceLocator)
        End If
    End Function
