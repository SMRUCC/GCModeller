#Region "Microsoft.VisualBasic::808d4f968f77229388d48110f7888981, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/referencegroup.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `referencegroup` (`DB_ID`, `atomicConnectivity`, `formula`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `referencegroup` (`DB_ID`, `atomicConnectivity`, `formula`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `referencegroup` (`DB_ID`, `atomicConnectivity`, `formula`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `referencegroup` (`DB_ID`, `atomicConnectivity`, `formula`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `referencegroup` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `referencegroup` SET `DB_ID`='{0}', `atomicConnectivity`='{1}', `formula`='{2}' WHERE `DB_ID` = '{3}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, atomicConnectivity, formula)
        Else
        Return String.Format(INSERT_SQL, DB_ID, atomicConnectivity, formula)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, atomicConnectivity, formula)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, atomicConnectivity, formula)
        End If
    End Function
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As referencegroup
                         Return DirectCast(MyClass.MemberwiseClone, referencegroup)
                     End Function
End Class
