#Region "Microsoft.VisualBasic::281dd58c5d21805c50855e51aa0cb4c7, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/reactionlikeevent_2_entityonothercell.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `reactionlikeevent_2_entityonothercell` (`DB_ID`, `entityOnOtherCell_rank`, `entityOnOtherCell`, `entityOnOtherCell_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `reactionlikeevent_2_entityonothercell` (`DB_ID`, `entityOnOtherCell_rank`, `entityOnOtherCell`, `entityOnOtherCell_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `reactionlikeevent_2_entityonothercell` (`DB_ID`, `entityOnOtherCell_rank`, `entityOnOtherCell`, `entityOnOtherCell_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `reactionlikeevent_2_entityonothercell` (`DB_ID`, `entityOnOtherCell_rank`, `entityOnOtherCell`, `entityOnOtherCell_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `reactionlikeevent_2_entityonothercell` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `reactionlikeevent_2_entityonothercell` SET `DB_ID`='{0}', `entityOnOtherCell_rank`='{1}', `entityOnOtherCell`='{2}', `entityOnOtherCell_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
