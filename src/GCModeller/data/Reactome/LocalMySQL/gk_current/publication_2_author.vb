...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `publication_2_author` (`DB_ID`, `author_rank`, `author`, `author_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `publication_2_author` (`DB_ID`, `author_rank`, `author`, `author_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `publication_2_author` (`DB_ID`, `author_rank`, `author`, `author_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `publication_2_author` (`DB_ID`, `author_rank`, `author`, `author_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `publication_2_author` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `publication_2_author` SET `DB_ID`='{0}', `author_rank`='{1}', `author`='{2}', `author_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
