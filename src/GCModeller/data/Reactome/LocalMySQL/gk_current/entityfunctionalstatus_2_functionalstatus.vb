#Region "Microsoft.VisualBasic::2508d74af56578ec201c80221cfdb49b, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/entityfunctionalstatus_2_functionalstatus.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `entityfunctionalstatus_2_functionalstatus` (`DB_ID`, `functionalStatus_rank`, `functionalStatus`, `functionalStatus_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `entityfunctionalstatus_2_functionalstatus` (`DB_ID`, `functionalStatus_rank`, `functionalStatus`, `functionalStatus_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `entityfunctionalstatus_2_functionalstatus` (`DB_ID`, `functionalStatus_rank`, `functionalStatus`, `functionalStatus_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `entityfunctionalstatus_2_functionalstatus` (`DB_ID`, `functionalStatus_rank`, `functionalStatus`, `functionalStatus_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `entityfunctionalstatus_2_functionalstatus` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `entityfunctionalstatus_2_functionalstatus` SET `DB_ID`='{0}', `functionalStatus_rank`='{1}', `functionalStatus`='{2}', `functionalStatus_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, functionalStatus_rank, functionalStatus, functionalStatus_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, functionalStatus_rank, functionalStatus, functionalStatus_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, functionalStatus_rank, functionalStatus, functionalStatus_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, functionalStatus_rank, functionalStatus, functionalStatus_class)
        End If
    End Function
