#Region "Microsoft.VisualBasic::5238dc776ac4fdb49e32afa83b1ff211, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/complex_2_includedlocation.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `complex_2_includedlocation` (`DB_ID`, `includedLocation_rank`, `includedLocation`, `includedLocation_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `complex_2_includedlocation` (`DB_ID`, `includedLocation_rank`, `includedLocation`, `includedLocation_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `complex_2_includedlocation` (`DB_ID`, `includedLocation_rank`, `includedLocation`, `includedLocation_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `complex_2_includedlocation` (`DB_ID`, `includedLocation_rank`, `includedLocation`, `includedLocation_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `complex_2_includedlocation` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `complex_2_includedlocation` SET `DB_ID`='{0}', `includedLocation_rank`='{1}', `includedLocation`='{2}', `includedLocation_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, includedLocation_rank, includedLocation, includedLocation_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, includedLocation_rank, includedLocation, includedLocation_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, includedLocation_rank, includedLocation, includedLocation_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, includedLocation_rank, includedLocation, includedLocation_class)
        End If
    End Function
