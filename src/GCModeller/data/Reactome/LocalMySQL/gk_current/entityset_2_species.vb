...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `entityset_2_species` (`DB_ID`, `species_rank`, `species`, `species_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `entityset_2_species` (`DB_ID`, `species_rank`, `species`, `species_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `entityset_2_species` (`DB_ID`, `species_rank`, `species`, `species_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `entityset_2_species` (`DB_ID`, `species_rank`, `species`, `species_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `entityset_2_species` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `entityset_2_species` SET `DB_ID`='{0}', `species_rank`='{1}', `species`='{2}', `species_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
