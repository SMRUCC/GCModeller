...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("go_biologicalprocess_2_instanceof", Database:="gk_current", SchemaSQL:="
CREATE TABLE `go_biologicalprocess_2_instanceof` (
  `DB_ID` int(10) unsigned DEFAULT NULL,
  `instanceOf_rank` int(10) unsigned DEFAULT NULL,
  `instanceOf` int(10) unsigned DEFAULT NULL,
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `go_biologicalprocess_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `go_biologicalprocess_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `go_biologicalprocess_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `go_biologicalprocess_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `go_biologicalprocess_2_instanceof` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `go_biologicalprocess_2_instanceof` SET `DB_ID`='{0}', `instanceOf_rank`='{1}', `instanceOf`='{2}', `instanceOf_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>

#End Region

''' <summary>
''' ```SQL
''' DELETE FROM `go_biologicalprocess_2_instanceof` WHERE `DB_ID` = '{0}';
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' INSERT INTO `go_biologicalprocess_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' REPLACE INTO `go_biologicalprocess_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' UPDATE `go_biologicalprocess_2_instanceof` SET `DB_ID`='{0}', `instanceOf_rank`='{1}', `instanceOf`='{2}', `instanceOf_class`='{3}' WHERE `DB_ID` = '{4}';
''' ```
''' </summary>
