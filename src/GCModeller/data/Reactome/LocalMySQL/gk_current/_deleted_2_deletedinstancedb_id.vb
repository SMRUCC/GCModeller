...
#Region "Public Property Mapping To Database Fields"
    ...
    <DatabaseField("deletedInstanceDB_ID_rank"), DataType(MySqlDbType.Int64, "10"), Column(Name:="deletedInstanceDB_ID_rank")> Public Property deletedInstanceDB_ID_rank As Long
    <DatabaseField("deletedInstanceDB_ID"), DataType(MySqlDbType.Int64, "10"), Column(Name:="deletedInstanceDB_ID")> Public Property deletedInstanceDB_ID As Long
#End Region
#Region "Public SQL Interface"
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `_deleted_2_deletedinstancedb_id` (`DB_ID`, `deletedInstanceDB_ID_rank`, `deletedInstanceDB_ID`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `_deleted_2_deletedinstancedb_id` (`DB_ID`, `deletedInstanceDB_ID_rank`, `deletedInstanceDB_ID`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `_deleted_2_deletedinstancedb_id` (`DB_ID`, `deletedInstanceDB_ID_rank`, `deletedInstanceDB_ID`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `_deleted_2_deletedinstancedb_id` (`DB_ID`, `deletedInstanceDB_ID_rank`, `deletedInstanceDB_ID`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `_deleted_2_deletedinstancedb_id` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `_deleted_2_deletedinstancedb_id` SET `DB_ID`='{0}', `deletedInstanceDB_ID_rank`='{1}', `deletedInstanceDB_ID`='{2}' WHERE `DB_ID` = '{3}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, deletedInstanceDB_ID_rank, deletedInstanceDB_ID)
        Else
        Return String.Format(INSERT_SQL, DB_ID, deletedInstanceDB_ID_rank, deletedInstanceDB_ID)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, deletedInstanceDB_ID_rank, deletedInstanceDB_ID)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, deletedInstanceDB_ID_rank, deletedInstanceDB_ID)
        End If
    End Function
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As _deleted_2_deletedinstancedb_id
                         Return DirectCast(MyClass.MemberwiseClone, _deleted_2_deletedinstancedb_id)
                     End Function
End Class
