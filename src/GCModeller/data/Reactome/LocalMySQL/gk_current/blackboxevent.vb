#Region "Microsoft.VisualBasic::f0c69cc4d855a89d20f7fd57adb18d03, data\Reactome\LocalMySQL\gk_current\blackboxevent.vb"
    ...
    ' Class blackboxevent
    ' 
    '     Properties: DB_ID, templateEvent, templateEvent_class
    ' 
...
#Region "Public Property Mapping To Database Fields"
    ...
    <DatabaseField("templateEvent"), DataType(MySqlDbType.Int64, "10"), Column(Name:="templateEvent")> Public Property templateEvent As Long
    <DatabaseField("templateEvent_class"), DataType(MySqlDbType.VarChar, "64"), Column(Name:="templateEvent_class")> Public Property templateEvent_class As String
#End Region
#Region "Public SQL Interface"
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `blackboxevent` (`DB_ID`, `templateEvent`, `templateEvent_class`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `blackboxevent` (`DB_ID`, `templateEvent`, `templateEvent_class`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `blackboxevent` (`DB_ID`, `templateEvent`, `templateEvent_class`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `blackboxevent` (`DB_ID`, `templateEvent`, `templateEvent_class`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `blackboxevent` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `blackboxevent` SET `DB_ID`='{0}', `templateEvent`='{1}', `templateEvent_class`='{2}' WHERE `DB_ID` = '{3}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, templateEvent, templateEvent_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, templateEvent, templateEvent_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, templateEvent, templateEvent_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, templateEvent, templateEvent_class)
        End If
    End Function
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As blackboxevent
                         Return DirectCast(MyClass.MemberwiseClone, blackboxevent)
                     End Function
End Class
