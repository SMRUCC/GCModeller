...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `pathwaydiagram_2_representedpathway` (`DB_ID`, `representedPathway_rank`, `representedPathway`, `representedPathway_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `pathwaydiagram_2_representedpathway` (`DB_ID`, `representedPathway_rank`, `representedPathway`, `representedPathway_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `pathwaydiagram_2_representedpathway` (`DB_ID`, `representedPathway_rank`, `representedPathway`, `representedPathway_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `pathwaydiagram_2_representedpathway` (`DB_ID`, `representedPathway_rank`, `representedPathway`, `representedPathway_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `pathwaydiagram_2_representedpathway` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `pathwaydiagram_2_representedpathway` SET `DB_ID`='{0}', `representedPathway_rank`='{1}', `representedPathway`='{2}', `representedPathway_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, representedPathway_rank, representedPathway, representedPathway_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, representedPathway_rank, representedPathway, representedPathway_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, representedPathway_rank, representedPathway, representedPathway_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, representedPathway_rank, representedPathway, representedPathway_class)
        End If
    End Function
