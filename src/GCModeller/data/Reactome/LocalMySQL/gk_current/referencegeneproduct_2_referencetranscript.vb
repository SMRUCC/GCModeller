...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `referencegeneproduct_2_referencetranscript` (`DB_ID`, `referenceTranscript_rank`, `referenceTranscript`, `referenceTranscript_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `referencegeneproduct_2_referencetranscript` (`DB_ID`, `referenceTranscript_rank`, `referenceTranscript`, `referenceTranscript_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `referencegeneproduct_2_referencetranscript` (`DB_ID`, `referenceTranscript_rank`, `referenceTranscript`, `referenceTranscript_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `referencegeneproduct_2_referencetranscript` (`DB_ID`, `referenceTranscript_rank`, `referenceTranscript`, `referenceTranscript_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `referencegeneproduct_2_referencetranscript` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `referencegeneproduct_2_referencetranscript` SET `DB_ID`='{0}', `referenceTranscript_rank`='{1}', `referenceTranscript`='{2}', `referenceTranscript_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, referenceTranscript_rank, referenceTranscript, referenceTranscript_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, referenceTranscript_rank, referenceTranscript, referenceTranscript_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, referenceTranscript_rank, referenceTranscript, referenceTranscript_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, referenceTranscript_rank, referenceTranscript, referenceTranscript_class)
        End If
    End Function
