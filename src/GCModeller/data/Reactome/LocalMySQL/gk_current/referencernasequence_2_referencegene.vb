...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `referencernasequence_2_referencegene` (`DB_ID`, `referenceGene_rank`, `referenceGene`, `referenceGene_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `referencernasequence_2_referencegene` (`DB_ID`, `referenceGene_rank`, `referenceGene`, `referenceGene_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `referencernasequence_2_referencegene` (`DB_ID`, `referenceGene_rank`, `referenceGene`, `referenceGene_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `referencernasequence_2_referencegene` (`DB_ID`, `referenceGene_rank`, `referenceGene`, `referenceGene_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `referencernasequence_2_referencegene` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `referencernasequence_2_referencegene` SET `DB_ID`='{0}', `referenceGene_rank`='{1}', `referenceGene`='{2}', `referenceGene_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As referencernasequence_2_referencegene
                         Return DirectCast(MyClass.MemberwiseClone, referencernasequence_2_referencegene)
                     End Function
End Class
