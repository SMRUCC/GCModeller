...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `event_2_inferredfrom` (`DB_ID`, `inferredFrom_rank`, `inferredFrom`, `inferredFrom_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `event_2_inferredfrom` (`DB_ID`, `inferredFrom_rank`, `inferredFrom`, `inferredFrom_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `event_2_inferredfrom` (`DB_ID`, `inferredFrom_rank`, `inferredFrom`, `inferredFrom_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `event_2_inferredfrom` (`DB_ID`, `inferredFrom_rank`, `inferredFrom`, `inferredFrom_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `event_2_inferredfrom` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `event_2_inferredfrom` SET `DB_ID`='{0}', `inferredFrom_rank`='{1}', `inferredFrom`='{2}', `inferredFrom_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
