...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `interchaincrosslinkedresidue_2_equivalentto` (`DB_ID`, `equivalentTo_rank`, `equivalentTo`, `equivalentTo_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `interchaincrosslinkedresidue_2_equivalentto` (`DB_ID`, `equivalentTo_rank`, `equivalentTo`, `equivalentTo_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `interchaincrosslinkedresidue_2_equivalentto` (`DB_ID`, `equivalentTo_rank`, `equivalentTo`, `equivalentTo_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `interchaincrosslinkedresidue_2_equivalentto` (`DB_ID`, `equivalentTo_rank`, `equivalentTo`, `equivalentTo_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `interchaincrosslinkedresidue_2_equivalentto` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `interchaincrosslinkedresidue_2_equivalentto` SET `DB_ID`='{0}', `equivalentTo_rank`='{1}', `equivalentTo`='{2}', `equivalentTo_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, equivalentTo_rank, equivalentTo, equivalentTo_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, equivalentTo_rank, equivalentTo, equivalentTo_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, equivalentTo_rank, equivalentTo, equivalentTo_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, equivalentTo_rank, equivalentTo, equivalentTo_class)
        End If
    End Function
