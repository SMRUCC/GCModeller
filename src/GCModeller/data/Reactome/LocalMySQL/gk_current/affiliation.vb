#Region "Microsoft.VisualBasic::a71ea54499017fcca4db3dcbbad4ab5b, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/affiliation.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `affiliation` (`DB_ID`, `address`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `affiliation` (`DB_ID`, `address`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `affiliation` (`DB_ID`, `address`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `affiliation` (`DB_ID`, `address`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `affiliation` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `affiliation` SET `DB_ID`='{0}', `address`='{1}' WHERE `DB_ID` = '{2}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, address)
        Else
        Return String.Format(INSERT_SQL, DB_ID, address)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, address)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, address)
        End If
    End Function
