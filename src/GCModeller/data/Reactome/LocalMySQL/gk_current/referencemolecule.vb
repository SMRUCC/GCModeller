...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `referencemolecule` (`DB_ID`, `atomicConnectivity`, `formula`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `referencemolecule` (`DB_ID`, `atomicConnectivity`, `formula`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `referencemolecule` (`DB_ID`, `atomicConnectivity`, `formula`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `referencemolecule` (`DB_ID`, `atomicConnectivity`, `formula`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `referencemolecule` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `referencemolecule` SET `DB_ID`='{0}', `atomicConnectivity`='{1}', `formula`='{2}' WHERE `DB_ID` = '{3}';</SQL>
