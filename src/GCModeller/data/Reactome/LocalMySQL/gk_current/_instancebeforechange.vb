...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `_instancebeforechange` (`DB_ID`, `changedInstanceDB_ID`, `instanceEdit`, `instanceEdit_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `_instancebeforechange` (`DB_ID`, `changedInstanceDB_ID`, `instanceEdit`, `instanceEdit_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `_instancebeforechange` (`DB_ID`, `changedInstanceDB_ID`, `instanceEdit`, `instanceEdit_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `_instancebeforechange` (`DB_ID`, `changedInstanceDB_ID`, `instanceEdit`, `instanceEdit_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `_instancebeforechange` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `_instancebeforechange` SET `DB_ID`='{0}', `changedInstanceDB_ID`='{1}', `instanceEdit`='{2}', `instanceEdit_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, changedInstanceDB_ID, instanceEdit, instanceEdit_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, changedInstanceDB_ID, instanceEdit, instanceEdit_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, changedInstanceDB_ID, instanceEdit, instanceEdit_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, changedInstanceDB_ID, instanceEdit, instanceEdit_class)
        End If
    End Function
