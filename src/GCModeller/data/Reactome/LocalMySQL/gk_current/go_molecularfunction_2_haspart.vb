...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `go_molecularfunction_2_haspart` (`DB_ID`, `hasPart_rank`, `hasPart`, `hasPart_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `go_molecularfunction_2_haspart` (`DB_ID`, `hasPart_rank`, `hasPart`, `hasPart_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `go_molecularfunction_2_haspart` (`DB_ID`, `hasPart_rank`, `hasPart`, `hasPart_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `go_molecularfunction_2_haspart` (`DB_ID`, `hasPart_rank`, `hasPart`, `hasPart_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `go_molecularfunction_2_haspart` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `go_molecularfunction_2_haspart` SET `DB_ID`='{0}', `hasPart_rank`='{1}', `hasPart`='{2}', `hasPart_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As go_molecularfunction_2_haspart
                         Return DirectCast(MyClass.MemberwiseClone, go_molecularfunction_2_haspart)
                     End Function
End Class
