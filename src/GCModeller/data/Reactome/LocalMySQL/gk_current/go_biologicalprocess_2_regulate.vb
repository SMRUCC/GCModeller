...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `go_biologicalprocess_2_regulate` (`DB_ID`, `regulate_rank`, `regulate`, `regulate_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `go_biologicalprocess_2_regulate` (`DB_ID`, `regulate_rank`, `regulate`, `regulate_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `go_biologicalprocess_2_regulate` (`DB_ID`, `regulate_rank`, `regulate`, `regulate_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `go_biologicalprocess_2_regulate` (`DB_ID`, `regulate_rank`, `regulate`, `regulate_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `go_biologicalprocess_2_regulate` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `go_biologicalprocess_2_regulate` SET `DB_ID`='{0}', `regulate_rank`='{1}', `regulate`='{2}', `regulate_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
