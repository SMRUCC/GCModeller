...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `groupmodifiedresidue` (`DB_ID`, `modification`, `modification_class`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `groupmodifiedresidue` (`DB_ID`, `modification`, `modification_class`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `groupmodifiedresidue` (`DB_ID`, `modification`, `modification_class`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `groupmodifiedresidue` (`DB_ID`, `modification`, `modification_class`) VALUES ('{0}', '{1}', '{2}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `groupmodifiedresidue` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `groupmodifiedresidue` SET `DB_ID`='{0}', `modification`='{1}', `modification_class`='{2}' WHERE `DB_ID` = '{3}';</SQL>
