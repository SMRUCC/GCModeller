...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `regulationtype_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `regulationtype_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `regulationtype_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `regulationtype_2_instanceof` (`DB_ID`, `instanceOf_rank`, `instanceOf`, `instanceOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `regulationtype_2_instanceof` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `regulationtype_2_instanceof` SET `DB_ID`='{0}', `instanceOf_rank`='{1}', `instanceOf`='{2}', `instanceOf_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
