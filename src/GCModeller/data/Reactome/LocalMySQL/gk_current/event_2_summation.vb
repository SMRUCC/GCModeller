#Region "Microsoft.VisualBasic::8cbca80a56c7a76795692f6ec04e27b1, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/event_2_summation.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `event_2_summation` (`DB_ID`, `summation_rank`, `summation`, `summation_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `event_2_summation` (`DB_ID`, `summation_rank`, `summation`, `summation_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `event_2_summation` (`DB_ID`, `summation_rank`, `summation`, `summation_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `event_2_summation` (`DB_ID`, `summation_rank`, `summation`, `summation_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `event_2_summation` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `event_2_summation` SET `DB_ID`='{0}', `summation_rank`='{1}', `summation`='{2}', `summation_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As event_2_summation
                         Return DirectCast(MyClass.MemberwiseClone, event_2_summation)
                     End Function
End Class
