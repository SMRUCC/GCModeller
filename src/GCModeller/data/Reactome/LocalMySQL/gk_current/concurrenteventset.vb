#Region "Microsoft.VisualBasic::34d3b521e6bec95e8ed22955256675ef, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/concurrenteventset.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `concurrenteventset` (`DB_ID`) VALUES ('{0}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `concurrenteventset` (`DB_ID`) VALUES ('{0}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `concurrenteventset` (`DB_ID`) VALUES ('{0}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `concurrenteventset` (`DB_ID`) VALUES ('{0}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `concurrenteventset` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `concurrenteventset` SET `DB_ID`='{0}' WHERE `DB_ID` = '{1}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As concurrenteventset
                         Return DirectCast(MyClass.MemberwiseClone, concurrenteventset)
                     End Function
End Class
