...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("physicalentity_2_reviewed", Database:="gk_current", SchemaSQL:="
CREATE TABLE `physicalentity_2_reviewed` (
  `DB_ID` int(10) unsigned DEFAULT NULL,
  `reviewed_rank` int(10) unsigned DEFAULT NULL,
  `reviewed` int(10) unsigned DEFAULT NULL,
...
Public Class physicalentity_2_reviewed: Inherits Oracle.LinuxCompatibility.MySQL.MySQLTable
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `physicalentity_2_reviewed` (`DB_ID`, `reviewed_rank`, `reviewed`, `reviewed_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `physicalentity_2_reviewed` (`DB_ID`, `reviewed_rank`, `reviewed`, `reviewed_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `physicalentity_2_reviewed` (`DB_ID`, `reviewed_rank`, `reviewed`, `reviewed_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `physicalentity_2_reviewed` (`DB_ID`, `reviewed_rank`, `reviewed`, `reviewed_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `physicalentity_2_reviewed` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `physicalentity_2_reviewed` SET `DB_ID`='{0}', `reviewed_rank`='{1}', `reviewed`='{2}', `reviewed_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>

#End Region

''' <summary>
''' ```SQL
''' DELETE FROM `physicalentity_2_reviewed` WHERE `DB_ID` = '{0}';
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' INSERT INTO `physicalentity_2_reviewed` (`DB_ID`, `reviewed_rank`, `reviewed`, `reviewed_class`) VALUES ('{0}', '{1}', '{2}', '{3}');
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' REPLACE INTO `physicalentity_2_reviewed` (`DB_ID`, `reviewed_rank`, `reviewed`, `reviewed_class`) VALUES ('{0}', '{1}', '{2}', '{3}');
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' UPDATE `physicalentity_2_reviewed` SET `DB_ID`='{0}', `reviewed_rank`='{1}', `reviewed`='{2}', `reviewed_class`='{3}' WHERE `DB_ID` = '{4}';
''' ```
''' </summary>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As physicalentity_2_reviewed
                         Return DirectCast(MyClass.MemberwiseClone, physicalentity_2_reviewed)
                     End Function
End Class
