#Region "Microsoft.VisualBasic::ba56480fed77d450c740cf94a42b589e, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/databaseobject_2_modified.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `databaseobject_2_modified` (`DB_ID`, `modified_rank`, `modified`, `modified_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `databaseobject_2_modified` (`DB_ID`, `modified_rank`, `modified`, `modified_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `databaseobject_2_modified` (`DB_ID`, `modified_rank`, `modified`, `modified_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `databaseobject_2_modified` (`DB_ID`, `modified_rank`, `modified`, `modified_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `databaseobject_2_modified` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `databaseobject_2_modified` SET `DB_ID`='{0}', `modified_rank`='{1}', `modified`='{2}', `modified_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, modified_rank, modified, modified_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, modified_rank, modified, modified_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, modified_rank, modified, modified_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, modified_rank, modified, modified_class)
        End If
    End Function
