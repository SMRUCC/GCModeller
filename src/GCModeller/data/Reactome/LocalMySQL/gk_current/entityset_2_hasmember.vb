#Region "Microsoft.VisualBasic::5c75e5162263207f426b6de2bbac92cf, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/entityset_2_hasmember.vb"
    ...
    ' 
    '     Properties: DB_ID, hasMember, hasMember_class, hasMember_rank
    ' 
...
#Region "Public Property Mapping To Database Fields"
    ...
    <DatabaseField("hasMember_rank"), DataType(MySqlDbType.Int64, "10"), Column(Name:="hasMember_rank")> Public Property hasMember_rank As Long
    <DatabaseField("hasMember"), DataType(MySqlDbType.Int64, "10"), Column(Name:="hasMember")> Public Property hasMember As Long
    <DatabaseField("hasMember_class"), DataType(MySqlDbType.VarChar, "64"), Column(Name:="hasMember_class")> Public Property hasMember_class As String
#End Region
#Region "Public SQL Interface"
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `entityset_2_hasmember` (`DB_ID`, `hasMember_rank`, `hasMember`, `hasMember_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `entityset_2_hasmember` (`DB_ID`, `hasMember_rank`, `hasMember`, `hasMember_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `entityset_2_hasmember` (`DB_ID`, `hasMember_rank`, `hasMember`, `hasMember_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `entityset_2_hasmember` (`DB_ID`, `hasMember_rank`, `hasMember`, `hasMember_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `entityset_2_hasmember` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `entityset_2_hasmember` SET `DB_ID`='{0}', `hasMember_rank`='{1}', `hasMember`='{2}', `hasMember_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, hasMember_rank, hasMember, hasMember_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, hasMember_rank, hasMember, hasMember_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, hasMember_rank, hasMember, hasMember_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, hasMember_rank, hasMember, hasMember_class)
        End If
    End Function
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As entityset_2_hasmember
                         Return DirectCast(MyClass.MemberwiseClone, entityset_2_hasmember)
                     End Function
End Class
