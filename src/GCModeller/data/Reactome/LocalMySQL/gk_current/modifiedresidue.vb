#Region "Microsoft.VisualBasic::db8320bda618429d7faeda2e7031b59e, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/modifiedresidue.vb"
...
Public Class modifiedresidue: Inherits Oracle.LinuxCompatibility.MySQL.MySQLTable
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `modifiedresidue` (`DB_ID`) VALUES ('{0}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `modifiedresidue` (`DB_ID`) VALUES ('{0}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `modifiedresidue` (`DB_ID`) VALUES ('{0}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `modifiedresidue` (`DB_ID`) VALUES ('{0}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `modifiedresidue` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `modifiedresidue` SET `DB_ID`='{0}' WHERE `DB_ID` = '{1}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As modifiedresidue
                         Return DirectCast(MyClass.MemberwiseClone, modifiedresidue)
                     End Function
End Class
