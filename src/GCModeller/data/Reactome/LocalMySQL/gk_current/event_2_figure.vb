#Region "Microsoft.VisualBasic::ab80f0d433dd35d5059b38d4aefdacbb, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/event_2_figure.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `event_2_figure` (`DB_ID`, `figure_rank`, `figure`, `figure_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `event_2_figure` (`DB_ID`, `figure_rank`, `figure`, `figure_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `event_2_figure` (`DB_ID`, `figure_rank`, `figure`, `figure_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `event_2_figure` (`DB_ID`, `figure_rank`, `figure`, `figure_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `event_2_figure` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `event_2_figure` SET `DB_ID`='{0}', `figure_rank`='{1}', `figure`='{2}', `figure_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As event_2_figure
                         Return DirectCast(MyClass.MemberwiseClone, event_2_figure)
                     End Function
End Class
