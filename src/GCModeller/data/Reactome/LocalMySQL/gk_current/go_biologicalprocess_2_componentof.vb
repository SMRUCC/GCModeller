#Region "Microsoft.VisualBasic::748d3dd5874554de81d7842482adb22c, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/go_biologicalprocess_2_componentof.vb"
    ...
    ' Class go_biologicalprocess_2_componentof
    ' 
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `go_biologicalprocess_2_componentof` (`DB_ID`, `componentOf_rank`, `componentOf`, `componentOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `go_biologicalprocess_2_componentof` (`DB_ID`, `componentOf_rank`, `componentOf`, `componentOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `go_biologicalprocess_2_componentof` (`DB_ID`, `componentOf_rank`, `componentOf`, `componentOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `go_biologicalprocess_2_componentof` (`DB_ID`, `componentOf_rank`, `componentOf`, `componentOf_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `go_biologicalprocess_2_componentof` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `go_biologicalprocess_2_componentof` SET `DB_ID`='{0}', `componentOf_rank`='{1}', `componentOf`='{2}', `componentOf_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As go_biologicalprocess_2_componentof
                         Return DirectCast(MyClass.MemberwiseClone, go_biologicalprocess_2_componentof)
                     End Function
End Class
