#Region "Microsoft.VisualBasic::ab264dda962f2d60c0f59ea72dd8e61f, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/go_biologicalprocess_2_positivelyregulate.vb"
    ...
    ' Class go_biologicalprocess_2_positivelyregulate
    ' 
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `go_biologicalprocess_2_positivelyregulate` (`DB_ID`, `positivelyRegulate_rank`, `positivelyRegulate`, `positivelyRegulate_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `go_biologicalprocess_2_positivelyregulate` (`DB_ID`, `positivelyRegulate_rank`, `positivelyRegulate`, `positivelyRegulate_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `go_biologicalprocess_2_positivelyregulate` (`DB_ID`, `positivelyRegulate_rank`, `positivelyRegulate`, `positivelyRegulate_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `go_biologicalprocess_2_positivelyregulate` (`DB_ID`, `positivelyRegulate_rank`, `positivelyRegulate`, `positivelyRegulate_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `go_biologicalprocess_2_positivelyregulate` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `go_biologicalprocess_2_positivelyregulate` SET `DB_ID`='{0}', `positivelyRegulate_rank`='{1}', `positivelyRegulate`='{2}', `positivelyRegulate_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As go_biologicalprocess_2_positivelyregulate
                         Return DirectCast(MyClass.MemberwiseClone, go_biologicalprocess_2_positivelyregulate)
                     End Function
End Class
