#Region "Microsoft.VisualBasic::01af949763c1ea5c8f956e0cbae94692, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/event_2_precedingevent.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `event_2_precedingevent` (`DB_ID`, `precedingEvent_rank`, `precedingEvent`, `precedingEvent_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `event_2_precedingevent` (`DB_ID`, `precedingEvent_rank`, `precedingEvent`, `precedingEvent_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `event_2_precedingevent` (`DB_ID`, `precedingEvent_rank`, `precedingEvent`, `precedingEvent_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `event_2_precedingevent` (`DB_ID`, `precedingEvent_rank`, `precedingEvent`, `precedingEvent_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `event_2_precedingevent` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `event_2_precedingevent` SET `DB_ID`='{0}', `precedingEvent_rank`='{1}', `precedingEvent`='{2}', `precedingEvent_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, precedingEvent_rank, precedingEvent, precedingEvent_class)
        Else
        Return String.Format(INSERT_SQL, DB_ID, precedingEvent_rank, precedingEvent, precedingEvent_class)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, precedingEvent_rank, precedingEvent, precedingEvent_class)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, precedingEvent_rank, precedingEvent, precedingEvent_class)
        End If
    End Function
