#Region "Microsoft.VisualBasic::1c7e966b5e6e0850656f5338112621eb, G:/GCModeller/src/GCModeller/data/Reactome//LocalMySQL/gk_current/referencegeneproduct.vb"
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `referencegeneproduct` (`DB_ID`, `_chainChangeLog`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `referencegeneproduct` (`DB_ID`, `_chainChangeLog`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `referencegeneproduct` (`DB_ID`, `_chainChangeLog`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `referencegeneproduct` (`DB_ID`, `_chainChangeLog`) VALUES ('{0}', '{1}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `referencegeneproduct` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `referencegeneproduct` SET `DB_ID`='{0}', `_chainChangeLog`='{1}' WHERE `DB_ID` = '{2}';</SQL>
...
''' </summary>
    Public Overrides Function GetInsertSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(INSERT_AI_SQL, DB_ID, _chainChangeLog)
        Else
        Return String.Format(INSERT_SQL, DB_ID, _chainChangeLog)
        End If
    End Function
...
''' </summary>
    Public Overrides Function GetReplaceSQL(AI As Boolean) As String
        If AI Then
        Return String.Format(REPLACE_AI_SQL, DB_ID, _chainChangeLog)
        Else
        Return String.Format(REPLACE_SQL, DB_ID, _chainChangeLog)
        End If
    End Function
