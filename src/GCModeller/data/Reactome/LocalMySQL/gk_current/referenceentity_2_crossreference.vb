...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("referenceentity_2_crossreference", Database:="gk_current", SchemaSQL:="
CREATE TABLE `referenceentity_2_crossreference` (
  `DB_ID` int(10) unsigned DEFAULT NULL,
  `crossReference_rank` int(10) unsigned DEFAULT NULL,
  `crossReference` int(10) unsigned DEFAULT NULL,
...
Public Class referenceentity_2_crossreference: Inherits Oracle.LinuxCompatibility.MySQL.MySQLTable
...
#Region "Interface SQL"
    Friend Shared ReadOnly INSERT_SQL$ = 
        <SQL>INSERT INTO `referenceentity_2_crossreference` (`DB_ID`, `crossReference_rank`, `crossReference`, `crossReference_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly INSERT_AI_SQL$ = 
        <SQL>INSERT INTO `referenceentity_2_crossreference` (`DB_ID`, `crossReference_rank`, `crossReference`, `crossReference_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_SQL$ = 
        <SQL>REPLACE INTO `referenceentity_2_crossreference` (`DB_ID`, `crossReference_rank`, `crossReference`, `crossReference_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly REPLACE_AI_SQL$ = 
        <SQL>REPLACE INTO `referenceentity_2_crossreference` (`DB_ID`, `crossReference_rank`, `crossReference`, `crossReference_class`) VALUES ('{0}', '{1}', '{2}', '{3}');</SQL>

    Friend Shared ReadOnly DELETE_SQL$ =
        <SQL>DELETE FROM `referenceentity_2_crossreference` WHERE `DB_ID` = '{0}';</SQL>

    Friend Shared ReadOnly UPDATE_SQL$ = 
        <SQL>UPDATE `referenceentity_2_crossreference` SET `DB_ID`='{0}', `crossReference_rank`='{1}', `crossReference`='{2}', `crossReference_class`='{3}' WHERE `DB_ID` = '{4}';</SQL>

#End Region

''' <summary>
''' ```SQL
''' DELETE FROM `referenceentity_2_crossreference` WHERE `DB_ID` = '{0}';
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' INSERT INTO `referenceentity_2_crossreference` (`DB_ID`, `crossReference_rank`, `crossReference`, `crossReference_class`) VALUES ('{0}', '{1}', '{2}', '{3}');
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' REPLACE INTO `referenceentity_2_crossreference` (`DB_ID`, `crossReference_rank`, `crossReference`, `crossReference_class`) VALUES ('{0}', '{1}', '{2}', '{3}');
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' UPDATE `referenceentity_2_crossreference` SET `DB_ID`='{0}', `crossReference_rank`='{1}', `crossReference`='{2}', `crossReference_class`='{3}' WHERE `DB_ID` = '{4}';
''' ```
''' </summary>
...
''' <summary>
                     ...
                     ''' </summary>
                     Public Function Clone() As referenceentity_2_crossreference
                         Return DirectCast(MyClass.MemberwiseClone, referenceentity_2_crossreference)
                     End Function
End Class
