#Region "Microsoft.VisualBasic::0528eca70c15b95b3f66cf17d6b8a093, data\Reactome\LocalMySQL\gk_stable_ids\name.vb"
...
''' <summary>
''' ```SQL
''' INSERT INTO `name` (`ST_ID`, `name`) VALUES ('{0}', '{1}');
''' ```
''' </summary>
...
''' <summary>
''' ```SQL
''' REPLACE INTO `name` (`ST_ID`, `name`) VALUES ('{0}', '{1}');
''' ```
''' </summary>
