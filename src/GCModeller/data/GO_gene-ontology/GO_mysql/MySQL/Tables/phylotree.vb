#Region "Microsoft.VisualBasic::6981b7d1e52bde930530e82d1bb77a5c, ..\GCModeller\data\GO_gene-ontology\GeneOntology\MySQL\Tables\phylotree.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("phylotree", Database:="go", SchemaSQL:="
CREATE TABLE `phylotree` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `dbxref_id` int(11) NOT NULL,
