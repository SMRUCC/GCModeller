#Region "Microsoft.VisualBasic::71de331e1aaebdad43f2114e6fc8ec31, ..\GCModeller\data\GO_gene-ontology\GeneOntology\MySQL\Tables\term_definition.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("term_definition", Database:="go", SchemaSQL:="
CREATE TABLE `term_definition` (
  `term_id` int(11) NOT NULL,
  `term_definition` text NOT NULL,
  `dbxref_id` int(11) DEFAULT NULL,
