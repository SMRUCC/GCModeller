#Region "Microsoft.VisualBasic::3a849636ca7fdc94ffb5f339fe4fb692, ..\GCModeller\data\GO_gene-ontology\GeneOntology\MySQL\Tables\evidence.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("evidence", Database:="go", SchemaSQL:="
CREATE TABLE `evidence` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(8) NOT NULL,
  `association_id` int(11) NOT NULL,
