#Region "Microsoft.VisualBasic::1e087aa78a0af2f4bbaab975bde80131, ..\GCModeller\data\GO_gene-ontology\GeneOntology\MySQL\Tables\graph_path.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("graph_path", Database:="go", SchemaSQL:="
CREATE TABLE `graph_path` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `term1_id` int(11) NOT NULL,
  `term2_id` int(11) NOT NULL,
