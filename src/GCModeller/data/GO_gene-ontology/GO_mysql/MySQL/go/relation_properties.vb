#Region "Microsoft.VisualBasic::4533d931715168a8eae65ba50394215f, ..\GCModeller\data\GO_gene-ontology\GeneOntology\MySQL\go\relation_properties.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("relation_properties", Database:="go", SchemaSQL:="
CREATE TABLE `relation_properties` (
  `relationship_type_id` int(11) NOT NULL,
  `is_transitive` int(11) DEFAULT NULL,
  `is_symmetric` int(11) DEFAULT NULL,
