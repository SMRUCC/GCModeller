#Region "Microsoft.VisualBasic::cc895235753f1a52f61f50d71e1fe1a7, ..\GCModeller\data\GO_gene-ontology\GeneOntology\MySQL\go\phylotree_property.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("phylotree_property", Database:="go", SchemaSQL:="
CREATE TABLE `phylotree_property` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `phylotree_id` int(11) NOT NULL,
  `property_key` varchar(64) NOT NULL,
