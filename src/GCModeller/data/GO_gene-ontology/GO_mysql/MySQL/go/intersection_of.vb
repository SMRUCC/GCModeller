#Region "Microsoft.VisualBasic::b4a11a8a4f43170cb77f3e0e4fb2ca56, ..\GCModeller\data\GO_gene-ontology\GeneOntology\MySQL\go\intersection_of.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("intersection_of", Database:="go", SchemaSQL:="
CREATE TABLE `intersection_of` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `relationship_type_id` int(11) NOT NULL,
  `term1_id` int(11) NOT NULL,
