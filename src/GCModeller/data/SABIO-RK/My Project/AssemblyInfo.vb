...
'查看程序集特性的值
#if netcore5=0 then
<Assembly: AssemblyTitle("SABIO-RK kinetic-laws parameter database")>
<Assembly: AssemblyDescription("SABIO-RK kinetic-laws parameter database")>
...
<Assembly: AssemblyTrademark("SABIO-RK")>

<Assembly: ComVisible(False)>

'如果此项目向 COM 公开，则下列 GUID 用于 typelib 的 ID
<Assembly: Guid("020cf50b-00af-4fb8-86b8-1123ee08f476")>
