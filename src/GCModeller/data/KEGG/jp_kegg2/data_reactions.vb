#Region "Microsoft.VisualBasic::57dd4e11f1301f5caa5ee87f5662320c, ..\GCModeller\data\KEGG\jp_kegg2\data_reactions.vb"
...
#Region "Interface SQL"
    Private Shared ReadOnly INSERT_SQL As String = <SQL>INSERT INTO `data_reactions` (`uid`, `KEGG`, `EC`, `name`, `definition`, `substrates`, `products`, `comment`) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}', '{7}');</SQL>
    Private Shared ReadOnly REPLACE_SQL As String = <SQL>REPLACE INTO `data_reactions` (`uid`, `KEGG`, `EC`, `name`, `definition`, `substrates`, `products`, `comment`) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}', '{7}');</SQL>
    Private Shared ReadOnly DELETE_SQL As String = <SQL>DELETE FROM `data_reactions` WHERE `uid` = '{0}';</SQL>
    Private Shared ReadOnly UPDATE_SQL As String = <SQL>UPDATE `data_reactions` SET `uid`='{0}', `KEGG`='{1}', `EC`='{2}', `name`='{3}', `definition`='{4}', `substrates`='{5}', `products`='{6}', `comment`='{7}' WHERE `uid` = '{8}';</SQL>
#End Region
''' <summary>
''' ```SQL
