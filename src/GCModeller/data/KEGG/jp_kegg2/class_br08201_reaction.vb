#Region "Microsoft.VisualBasic::f5cc4b91a5123dface216bae2a1d3336, ..\GCModeller\data\KEGG\jp_kegg2\class_br08201_reaction.vb"
...
#Region "Interface SQL"
    Private Shared ReadOnly INSERT_SQL As String = <SQL>INSERT INTO `class_br08201_reaction` (`uid`, `rn`, `name`, `EC`, `level1`, `level2`, `level3`) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}');</SQL>
    Private Shared ReadOnly REPLACE_SQL As String = <SQL>REPLACE INTO `class_br08201_reaction` (`uid`, `rn`, `name`, `EC`, `level1`, `level2`, `level3`) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}');</SQL>
    Private Shared ReadOnly DELETE_SQL As String = <SQL>DELETE FROM `class_br08201_reaction` WHERE `uid` = '{0}';</SQL>
    Private Shared ReadOnly UPDATE_SQL As String = <SQL>UPDATE `class_br08201_reaction` SET `uid`='{0}', `rn`='{1}', `name`='{2}', `EC`='{3}', `level1`='{4}', `level2`='{5}', `level3`='{6}' WHERE `uid` = '{7}';</SQL>
#End Region
''' <summary>
''' ```SQL
