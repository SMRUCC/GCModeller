#Region "Microsoft.VisualBasic::7791a8f459d176d30c995b9d70349ba6, ..\GCModeller\engine\GCTabular\CsvTabularData\XmlLoader.vb"
...
#End Region
        ...
        Private Function SaveCsvData(Of T As Class)(File As String, data As Generic.IEnumerable(Of T)) As Microsoft.VisualBasic.ComponentModel.Href
            If FileIO.FileSystem.FileExists(File) Then
                Call FileIO.FileSystem.DeleteFile(File, FileIO.UIOption.OnlyErrorDialogs, FileIO.RecycleOption.SendToRecycleBin)
            End If
