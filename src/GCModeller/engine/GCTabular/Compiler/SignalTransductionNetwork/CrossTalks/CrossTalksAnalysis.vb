...
Namespace Compiler.Components
    ...
    Public Module CrossTalksAnalysis
        ...
        ''' 
        <ExportAPI("Analysis")>
        Public Function Analysis(Model As FileStream.IO.XmlresxLoader, CrossTalks As Microsoft.VisualBasic.DocumentFormat.Csv.DocumentStream.File) As CrossTalks()
