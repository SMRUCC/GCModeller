#Region "Microsoft.VisualBasic::be040aba25833f32144c75e4c95ac441, ..\GCModeller\engine\GCMarkupLanguage\GCML_Documents\GCMLDocBuilder\ModelExport.vb"
...
Namespace Builder
    ...
    Public Module ModelExport
        ...
        <Extension> Public Function ExportModel(Model As SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.DocumentFormat.GCMarkupLanguage.BacterialModel) As Microsoft.VisualBasic.DocumentFormat.Csv.DocumentStream.File
        ...
        <Extension> Public Function GetAssociatedGenes(Model As SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.DocumentFormat.GCMarkupLanguage.BacterialModel, Reaction As SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.DocumentFormat.GCMarkupLanguage.GCML_Documents.XmlElements.Metabolism.Reaction) As String
