...
Namespace Core
    ...
    Public Class MassTable : Implements IEnumerable(Of Factor)
        ...
        Friend ReadOnly m_massSet As New CompartTable(Me)
        Friend ReadOnly m_referenceIds As New Dictionary(Of String, String)

#Region "snapshot and debug view"
...
#End Region
        ...
        Public Sub AddOrUpdate(entity As Factor, key As String, compart As String)
            ...
            m_massSet.mapping(entity.ID) = (entity.template_id, compart)
        End Sub
