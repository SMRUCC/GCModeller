#Region "Microsoft.VisualBasic::fa50479a6463b752083c2bbf481bd018, engine\IO\Raw\HDS\GCModellerRaw\StorageDriver.vb"
    ...
    '   Total Lines: 219
    '    Code Lines: 151 (68.95%)
    ' Comment Lines: 31 (14.16%)
    '    - Xml Docs: 45.16%
    ' 
    '   Blank Lines: 37 (16.89%)
    '     File Size: 11.55 KB
    ...
    ' 
    '         Function: GetStream, metabolome, proteome, transcriptome
    ' 
    '         Sub: (+2 Overloads) Dispose, FluxSnapshot, ForwardRegulation, MassSnapshot, ReverseRegulation
    '              SetSymbolNames, WriteCellularGraph
    ' 
    ' 
    ' /********************************************************************************/
