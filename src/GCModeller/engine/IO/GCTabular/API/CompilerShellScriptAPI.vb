#Region "Microsoft.VisualBasic::0477e8d3f6d6f8b2683671b46a63e93c, engine\IO\GCTabular\API\CompilerShellScriptAPI.vb"
    ...
    ' Module CompilerShellScriptAPI
    ' 
    '     Function: AnalysisTransmembraneFlux, ApplyFBAOptimization, Compile, CreateLoader, CreateNewModel
    '               CreateOperator, ExtractSensingProfiles, Fill_KEGG, Fill_Sabiork, GetModle
    '               LoadModel, NewXmlLoader, OptimizationModel, PreCompile, ReadModelXml
    '               SaveProfile, TransmembraneMatch, WriteEncryptedModel, WriteModel
    ' 
    ' /********************************************************************************/
