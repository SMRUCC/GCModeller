#Region "Microsoft.VisualBasic::d2863f47583fde6d7dbdb7e9ac2800ab, engine\Model\LocalRepository\Reaction.vb"
    ...
    '     Class Reaction
    ' 
    '         Properties: db_xrefs, ec_numbers, ECNumbers, guid, law
    '                     left, name, reaction, right
    ' 
    '         Function: ToString
    ' 
    '     Class Substrate
    ...
    '     Class LawData
    ' 
    '         Properties: character, ec_number, lambda, metabolite_id, params
    ' 
    '         Function: ToString
    ' 
    ' 
