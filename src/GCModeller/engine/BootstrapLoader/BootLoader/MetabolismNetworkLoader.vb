#Region "Microsoft.VisualBasic::c32a3d0137184cbc79f71d484a506edf, engine\BootstrapLoader\BootLoader\MetabolismNetworkLoader.vb"
    ...
    '   Total Lines: 288
    '    Code Lines: 232 (80.56%)
    ' Comment Lines: 18 (6.25%)
    '    - Xml Docs: 38.89%
    ' 
    '   Blank Lines: 38 (13.19%)
    '     File Size: 12.91 KB
    ...
    ' 
    '         Function: compart_id, CreateFlux, fluxByReaction, generalFluxExpansion, GetMassSet
    '                   productInhibitionFactor, SetParameterLinks
    ' 
    '         Sub: (+2 Overloads) SetParameterLinks
    ' 
    ' 
    ' /********************************************************************************/
