#Region "Microsoft.VisualBasic::0a1c62caf8792b2b496d730fc65dd1d1, ..\GCModeller\engine\GCModeller\EngineSystem\Engine\MathematicsModels\GenericKinetic.vb"
...
Namespace EngineSystem.MathematicsModels
    ...
    Public Class GenericKinetic : Inherits MathematicsModel
        ...
        ''' <summary>
        ''' 不要使用<see cref="Microsoft.VisualBasic.DumpNode">Dump特性</see>，否则会出现无限递归
        ''' </summary>
        ''' <remarks></remarks>
