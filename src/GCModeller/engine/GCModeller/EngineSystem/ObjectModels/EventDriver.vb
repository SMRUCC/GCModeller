#Region "Microsoft.VisualBasic::2bcdfa8e60a9eadf4c9b5f5caa2d5222, ..\GCModeller\engine\GCModeller\EngineSystem\ObjectModels\EventDriver.vb"
...
#End Region
        ...
        Public Sub ConnectCultivationMediumSystem(obj As ObjectModels.SubSystem.CultivationMediums)
            ...
            Dim WaterId As String =
                _cellObject.get_runtimeContainer.SystemVariable(Assembly.DocumentFormat.GCMarkupLanguage.GCML_Documents.ComponentModels.SystemVariables.ID_WATER)
