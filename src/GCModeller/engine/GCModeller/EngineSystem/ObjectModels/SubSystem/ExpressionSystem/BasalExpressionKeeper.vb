#Region "Microsoft.VisualBasic::fe2b4b783ba96a91a815b079c4fe87e8, ..\GCModeller\engine\GCModeller\EngineSystem\ObjectModels\SubSystem\ExpressionSystem\BasalExpressionKeeper.vb"
...
Namespace EngineSystem.ObjectModels.SubSystem.ExpressionSystem
    ...
    Public Class BasalExpressionKeeper : Inherits SubSystemContainer(Of [Module].CentralDogmaInstance.BasalExpression)
        ...
        Public Overrides Function Initialize() As Integer
            ...
            Call SystemLogging.WriteLine("   ---> Apply constraints to the basal expression events", "", Type:=MSG_TYPES.INF)
            ...
            Call SystemLogging.WriteLine("   ---> Apply constraints to the translation events", "", Type:=MSG_TYPES.INF)
