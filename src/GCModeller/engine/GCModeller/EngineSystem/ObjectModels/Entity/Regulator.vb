#Region "Microsoft.VisualBasic::97faec6f65e19957fb6f7bdd1b237f43, ..\GCModeller\engine\GCModeller\EngineSystem\ObjectModels\Entity\Regulator.vb"
...
Namespace EngineSystem.ObjectModels.Entity
    ...
    Public Class Regulator(Of TEvent As ObjectModels.Module.CentralDogmaInstance.ExpressionProcedureEvent.I_EventProcess) : Inherits Compound
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Overloads Shared Function CreateObject(ModelBase As SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.DocumentFormat.GCMarkupLanguage.GCML_Documents.XmlElements.SignalTransductions.Regulator,
