#Region "Microsoft.VisualBasic::e27c7ef17e65971135418e090374393f, models\SBML\Biopax\Level3\ResourceReader.vb"
    ...
    '   Total Lines: 171
    '    Code Lines: 139 (81.29%)
    ' Comment Lines: 4 (2.34%)
    '    - Xml Docs: 100.00%
    ' 
    ...
    Public Class ResourceReader
        ...
        Private Iterator Function GetCompoundResource(idSet As IEnumerable(Of EntityProperty), participantStoichiometry As Dictionary(Of String, Stoichiometry), entity_refs As Boolean) As IEnumerable(Of CompoundSpecieReference)
            For Each refer As EntityProperty In idSet
                ...
                Dim cellularLocation As term = Nothing
        ...
        Public Shared Function LoadResource(file As File) As ResourceReader
            ...
            reader.cellularLocations = file.CellularLocationVocabulary.SafeQuery.ToDictionary(Function(c) If(c.RDFId, c.about))
            reader.stoichiometry = file.Stoichiometry.SafeQuery.ToDictionary(Function(c) If(c.RDFId, c.about))
            reader.unificationXrefs = file.UnificationXref.SafeQuery.ToDictionary(Function(x) If(x.RDFId, x.about))
