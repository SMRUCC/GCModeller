...
Namespace Data
    ...
    Public Module SmilesSanitizer
        ...
        ''' </summary>
        ReadOnly supportedElements As New HashSet(Of String)(New String() {"C", "N", "O", "S", "P", "F", "I", "B", "H", "Cl", "Br", "Si"}, StringComparer.Ordinal)
        ...
        Private ReadOnly AtomBody As New Regex("^(Cl|Br|Si|C|N|O|S|P|F|I|B|H)(H[0-9]*)?([+-][0-9]*)?$", RegexOptions.Compiled)
