'' $Id: EBeyeClient.vb 2635 2013-04-24 19:42:24Z hpm $
'' ======================================================================
'' 
...
'Imports LANS.SystemsBiology.DatabaseServices.WebServices.EbiWS.EBeyeWs ' "Web Reference" or wsdl.exe generated stubs.
...
'                Return _srvProxy
'            End Get
'            Set( value As EBISearchService)
'                _srvProxy = value
'            End Set
'        End Property
'        ' Client object revision.
'        Private revision As String = "$Revision: 2635 $"
...
'        Private Function ConstuctUserAgentStr( revision As String,  clientClassName As String,  userAgent As String) As String
...
'        Public Function GetNumberOfResults( domain As String,  query As String) As Integer
...
'        Public Sub PrintGetNumberOfResults( domain As String,  query As String)
...
'        Public Function GetResultsIds( domain As String,  query As String,  start As Integer,  size As Integer) As String()
...
'        Public Sub PrintGetResultsIds( domain As String,  query As String,  start As Integer,  size As Integer)
...
'        ' Print the set of entry identifiers matching a query.
'        Public Sub PrintGetResultsIds( domain As String,  query As String,  start As String,  size As String)
'            PrintDebugMessage("PrintGetResultsIds", "Begin", 1)
...
'        Public Function GetAllResultsIds( domain As String,  query As String) As String()
...
'        ' Print the set of entry identifiers matching a query.
'        Public Sub PrintGetAllResultsIds( domain As String,  query As String)
...
'        Public Function ListFields( domain As String) As String()
...
'        Public Sub PrintListFields( domain As String)
...
'        Public Function GetResults( domain As String,  query As String,  fields As String(),  start As Integer,  size As Integer) As String()()
...
'        Public Sub PrintGetResults( domain As String,  query As String,  fields As String(),  start As Integer,  size As Integer)
...
'        ' Print data from retrievable fields for a query.
'        Public Sub PrintGetResults( domain As String,  query As String,  fields As String,  start As String,  size As String)
'            PrintDebugMessage("PrintGetResults", "Begin", 1)
...
'        Public Function GetEntry( domain As String,  entry As String,  fields As String()) As String()
...
'        Public Sub PrintGetEntry( domain As String,  entry As String,  fields As String())
...
'        Public Function GetEntries( domain As String,  entries As String(),  fields As String()) As String()()
...
'        Public Sub PrintGetEntries( domain As String,  entries As String(),  fields As String())
...
'        Public Function GetEntryFieldUrls( domain As String,  entry As String,  fields As String()) As String()
...
'        Public Sub PrintGetEntryFieldUrls( domain As String,  entry As String,  fields As String())
...
'        Public Function GetEntriesFieldUrls( domain As String,  entries As String(),  fields As String()) As String()()
...
'        Public Sub PrintGetEntriesFieldUrls( domain As String,  entries As String(),  fields As String())
...
'        Public Function GetDomainsReferencedInDomain( domain As String) As String()
...
'        Public Sub PrintGetDomainsReferencedInDomain( domain As String)
...
'        Public Function GetDomainsReferencedInEntry( domain As String,  entry As String) As String()
...
'        Public Sub PrintGetDomainsReferencedInEntry( domain As String,  entry As String)
...
'        Public Function ListAdditionalReferenceFields( domain As String) As String()
...
'        Public Sub PrintListAdditionalReferenceFields( domain As String)
...
'        Public Function GetReferencedEntries( domain As String,  entry As String,  referencedDomain As String) As String()
...
'        Public Sub PrintGetReferencedEntries( domain As String,  entry As String,  referencedDomain As String)
...
'        Public Function GetReferencedEntriesSet( domain As String,  entries As String(),  referencedDomain As String,  fields As String()) As EntryReferences()
...
'        Public Sub PrintGetReferencedEntriesSet( domain As String,  entries As String(),  referencedDomain As String,  fields As String())
...
'        ' Get data from entries in a specified domain cross-referenced by set of entries.
'        Public Function GetReferencedEntriesFlatSet( domain As String,  entries As String(),  referencedDomain As String,  fields As String()) As String()()
...
'        ' Print data from entries in a specified domain cross-referenced by set of entries.
'        Public Sub PrintGetReferencedEntriesFlatSet( domain As String,  entries As String(),  referencedDomain As String,  fields As String())
...
'        Private Sub PrintDomainDescription( domain As DomainDescription,  indent As String)
...
'        Public Function GetDetailledNumberOfResults( domain As String,  query As String,  flat As Boolean) As DomainResult
...
'        Public Sub PrintGetDetailledNumberOfResults( domain As String,  query As String,  flat As Boolean)
...
'        ' Print tree of the number of results for each subdomain under the domain searched.
'        Public Sub PrintGetDetailledNumberOfResults( domain As String,  query As String,  flat As String)
'            PrintDebugMessage("PrintGetDetailledNumberOfResults", "Begin", 1)
...
'        Private Sub PrintDomainResults( domain As DomainResult,  indent As String)
...
'        Public Function ListFieldsInformation( domain As String) As EbiWS.EBeyeWs.FieldInfo()
...
'        Public Sub PrintListFieldsInformation( domain As String)
...
'        Public Function GetFacets( domain As String,  query As String) As EbiWS.EBeyeWs.Facet()
...
'        Public Sub PrintGetFacets( domain As String,  query As String)
...
'        Private Function SplitString( inStr As String,  seperators As Char()) As String()
...
'        Private Function SplitString( inStr As String) As String()
'            PrintDebugMessage("SplitString", "Begin", 11)
...
'        Private Sub PrintArrayOfStringList( arrayList As String()(),  table As Boolean)
