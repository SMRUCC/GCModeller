#Region "Microsoft.VisualBasic::f3441ed68e6eb3cef8f75c1519fe1cfd, annotations\Bifrost\Prodigal\RbsModel.vb"
    ...
    '   Total Lines: 264
    '    Code Lines: 182 (68.94%)
    ' Comment Lines: 47 (17.80%)
    '    - Xml Docs: 55.32%
    ' 
    '   Blank Lines: 35 (13.26%)
    '     File Size: 10.07 KB


    ' Class RbsModel
    ' 
    '     Function: BaseToIndex, ComputeRbsScore, ComputeSpacingScore
    ' 
    '     Sub: BuildModel, BuildRbsPwm
    ' 
    ' /********************************************************************************/
