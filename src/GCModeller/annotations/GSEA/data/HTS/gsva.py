...
def run_diff(gsva_score) :
    ...
    return data.frame(pathNames = pathName, mean_A01 = m1, mean_CK = m2, sd_A01 = sd1, sd_CK = sd2, foldchange = foldchange, log2fc = log2fc, t = t, pvalue = pvalue)
