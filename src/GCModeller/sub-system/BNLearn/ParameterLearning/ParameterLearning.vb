...
Namespace ParameterLearning
    ...
    Public Class BnParameterLearner
        ...
        Private Sub LearnRoot(ByRef cpd As Core.BnCPD, ByRef y As Double())
            ' 无父节点：边际分布 N(μ, σ²)
        ...
        Private Sub LearnRegression(ByRef cpd As Core.BnCPD, ByRef y As Double(), ByRef node As Core.BnNode, ByRef data As Core.GeneExpressionData)
        ...
        Public Function Learn(network As Core.BayesianNetwork, data As Core.GeneExpressionData) As ParameterLearningResult
            ...
            For Each nodeIdx As Integer In TqdmWrapper.Wrap(topoOrder)
                ...
                Dim cpd As New Core.BnCPD() With {
                    .NodeIndex = nodeIdx,
                    .NSamples = nS
                }
                ...
                If node.Parents.Count = 0 Then
                    Call LearnRoot(cpd, y)
                Else
                    Call LearnRegression(cpd, y, node, data)
                End If
