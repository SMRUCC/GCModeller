#Region "Microsoft.VisualBasic::328b8b16b2052a8520ec1e121444a069, sub-system\BNLearn\Core\BayesianNetwork.vb"
...
'   Total Lines: 351
'    Code Lines: 228 (64.96%)
' Comment Lines: 58 (16.52%)
'    - Xml Docs: 58.62%
' 
'   Blank Lines: 65 (18.52%)
'     File Size: 12.76 KB


'     Class BnNode
' 
'         Properties: Children, CPD, Index, Level, Name
'                     Parents
' 
'         Function: ToString
' 
...
' 
'         Properties: Adjacency, Blacklist, EdgeCount, NameToIndex, Nodes
'                     Whitelist
' 
'         Constructor: (+2 Overloads) Sub New
' 
'         Function: AddEdge, AddNode, CloneStructure, GetEdges, GetNodeIndex
'                   HasEdge, IsDAG, MakeBlackIndex, TopologicalSort, ToString
'                   WouldCreateCycle
' 
'         Sub: AddBlacklistEdge, AddWhitelistEdge, RemoveEdge, ResizeAdjacency
' 
' 
' /********************************************************************************/
...
Namespace Core
    ...
    Public Class BayesianNetwork
        ...
        Public Function TopologicalSort(<CallerMemberName> Optional callee As String = Nothing) As Integer()
            If Not _topoDirty AndAlso _topoOrder IsNot Nothing Then
                Return _topoOrder
            Else
                Call $"[{callee}] make network topological sort!".debug
            End If
