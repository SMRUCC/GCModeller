...
Namespace Assembly.NCBI.Entrez
    ...
    Public Class QueryHandler
        ...
        Public Class Entry : Inherits Entrez.ComponentModels.I_QueryEntry
            ...
            ''' <returns></returns>
            ''' <remarks></remarks>
            Public Function DownloadGBK(work As String) As LANS.SystemsBiology.Assembly.NCBI.GenBank.GBFF.File
                Dim SavedGBK As String = DownloadGBK(work, Me.AccessionId)
                Dim GBK As LANS.SystemsBiology.Assembly.NCBI.GenBank.GBFF.File = Nothing

                If FileIO.FileSystem.FileExists(SavedGBK) AndAlso FileIO.FileSystem.GetFileInfo(SavedGBK).Length > 0 Then
                    GBK = LANS.SystemsBiology.Assembly.NCBI.GenBank.GBFF.File.Read(SavedGBK)
                Else
