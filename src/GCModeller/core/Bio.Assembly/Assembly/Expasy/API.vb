#Region "Microsoft.VisualBasic::164530d0cc9c93ed4820d8e8865e98ba, G:/GCModeller/src/GCModeller/core/Bio.Assembly//Assembly/Expasy/API.vb"
    ...
    '         Delegate Function
    ' 
    '             Function: __generateAnnotations, __getKEGGReaction, InvokeAnnotations, InvokeKEGGAnnotations
    ' 
    ' 
    ' 
    ' /********************************************************************************/
...
Namespace Assembly.Expasy.AnnotationsTool
    ...
    Public Module API
        ...
        Private Function __getKEGGReaction(EC As EnzymeClass, KEGG As Generic.IEnumerable(Of KEGG.DBGET.bGetObject.Reaction)) As EnzymeClass
            ...
            EC.KEGG_ENTRIES = (From item In LQuery Select String.Format("[{0}] {1}", item.ID, item.Equation)).ToArray
            Return EC
        End Function
