#Region "Microsoft.VisualBasic::97deed6c3292c3f4d99af67086804b38, Bio.Assembly\Assembly\DOOR\Models\Operon.vb"
...
Namespace Assembly.DOOR
    ...
    Public Class Operon : Inherits KeyValuePairObject(Of String, OperonGene())
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Overrides Property Key As String Implements INamedValue.nodes
            Get
                Return MyBase.Key
            End Get
            Set(value As String)
