#Region "Microsoft.VisualBasic::0ee204900c0426d19529259e6948c21b, Bio.Assembly\Assembly\MetaCyc\Schemas\DBLink.vb"
...
Namespace Assembly.MetaCyc.Schema
    ...
    Public Class DBLinkManager : Inherits DBLinksManager(Of DBLink)
        ...
        Public Class DBLink : Implements IDBLink
            ...
            Public Property DBName As String Implements IDBLink.nodes
            Public Property AccessionId As String Implements IDBLink.edges
