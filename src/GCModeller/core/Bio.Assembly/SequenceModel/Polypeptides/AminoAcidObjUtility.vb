...
Namespace SequenceModel.Polypeptides
    ...
    Public Module AminoAcidObjUtility
        ...
        ''' </summary>
        Public ReadOnly AminoAcidLetters As IReadOnlyCollection(Of Char) = New Char() {"A"c, "R"c, "N"c, "D"c, "C"c, "E"c, "Q"c, "G"c, "H"c, "I"c, "L"c, "K"c, "M"c, "F"c, "P"c, "S"c, "T"c, "W"c, "Y"c, "V"c, "U"c, "O"c, "J"c}
