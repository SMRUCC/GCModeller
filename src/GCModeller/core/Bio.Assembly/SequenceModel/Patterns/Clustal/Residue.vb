#Region "Microsoft.VisualBasic::fa5d8331654199c3866ef1bd4536c7b7, ..\core\Bio.Assembly\SequenceModel\Patterns\Clustal\Residue.vb"
...
Namespace SequenceModel.Patterns.Clustal
    ...
    Public Class SR
        ...
        Private Shared Function __allocBlock(source As SR()(), cutoff As Double) As SR()()
            Dim chains As SR()() = source.First.Length.Select(Function(row) source.Select(Function(x) x(row)).ToArray)
