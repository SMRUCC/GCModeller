...
Namespace GCModellerApps
    ...
    Public Class Cytoscape : Inherits InteropService
        ...
        ''' </summary>
        '''
        Public Function Analysis_Node_Clusters(_in As String, Optional _size As String = "", Optional _schema As String = "", Optional _out As String = "", Optional _spcc As Boolean = False) As Integer
