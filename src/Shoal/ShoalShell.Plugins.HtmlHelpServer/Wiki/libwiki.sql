...
--
-- Table structure for table `lib_wikiarchive`
--
...
--
-- Table structure for table `lib_wikicategory`
--
...
--
-- Table structure for table `lib_wikicategorylinks`
--
...
--
-- Table structure for table `lib_wikichange_tag`
--
...
--
-- Table structure for table `lib_wikiexternallinks`
--
...
--
-- Table structure for table `lib_wikifilearchive`
--
...
--
-- Table structure for table `lib_wikiimage`
--
...
--
-- Table structure for table `lib_wikiimagelinks`
--
...
--
-- Table structure for table `lib_wikiinterwiki`
--
...
--
-- Table structure for table `lib_wikiipblocks`
--
...
--
-- Table structure for table `lib_wikiiwlinks`
--
...
--
-- Table structure for table `lib_wikijob`
--
...
--
-- Table structure for table `lib_wikil10n_cache`
--
...
--
-- Table structure for table `lib_wikilanglinks`
--
...
--
-- Table structure for table `lib_wikilog_search`
--
...
--
-- Table structure for table `lib_wikilogging`
--
...
--
-- Table structure for table `lib_wikimodule_deps`
--
...
--
-- Table structure for table `lib_wikimsg_resource`
--
...
--
-- Table structure for table `lib_wikimsg_resource_links`
--
...
--
-- Table structure for table `lib_wikiobjectcache`
--
...
--
-- Table structure for table `lib_wikioldimage`
--
...
--
-- Table structure for table `lib_wikipage`
--
...
--
-- Table structure for table `lib_wikipage_props`
--
...
--
-- Table structure for table `lib_wikipage_restrictions`
--
...
--
-- Table structure for table `lib_wikipagelinks`
--
...
--
-- Table structure for table `lib_wikiprotected_titles`
--
...
--
-- Table structure for table `lib_wikiquerycache`
--
...
--
-- Table structure for table `lib_wikiquerycache_info`
--
...
--
-- Table structure for table `lib_wikiquerycachetwo`
--
...
--
-- Table structure for table `lib_wikirecentchanges`
--
...
--
-- Table structure for table `lib_wikiredirect`
--
...
--
-- Table structure for table `lib_wikirevision`
--
...
--
-- Table structure for table `lib_wikisearchindex`
--
...
--
-- Table structure for table `lib_wikisite_identifiers`
--
...
--
-- Table structure for table `lib_wikisite_stats`
--
...
--
-- Table structure for table `lib_wikisites`
--
...
--
-- Table structure for table `lib_wikitag_summary`
--
...
--
-- Table structure for table `lib_wikitemplatelinks`
--
...
--
-- Table structure for table `lib_wikitext`
--
...
--
-- Table structure for table `lib_wikitranscache`
--
...
--
-- Table structure for table `lib_wikiupdatelog`
--
...
--
-- Table structure for table `lib_wikiuploadstash`
--
...
--
-- Table structure for table `lib_wikiuser`
--
...
--
-- Table structure for table `lib_wikiuser_former_groups`
--
...
--
-- Table structure for table `lib_wikiuser_groups`
--
...
--
-- Table structure for table `lib_wikiuser_newtalk`
--
...
--
-- Table structure for table `lib_wikiuser_properties`
--
...
--
-- Table structure for table `lib_wikivalid_tag`
--
...
--
-- Table structure for table `lib_wikiwatchlist`
--
