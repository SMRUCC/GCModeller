#Region "Microsoft.VisualBasic::95f2ad0964671e5cba015b15243b99ad, modules\Knowledge_base\ncbi_kb\eutils\PubMedEUtilities.vb"
    ...
    '   Total Lines: 1154
    '    Code Lines: 797 (69.06%)
    ' Comment Lines: 173 (14.99%)
    '    - Xml Docs: 43.93%
    ' 
    '   Blank Lines: 184 (15.94%)
    '     File Size: 52.52 KB


    '     Class PubMedArticle
    ' 
    '         Properties: Abstract, Authors, Citation, Doi, HasPmcFullText
    '                     Issn, Issue, Journal, JournalAbbrev, Messages
    '                     Pages, PmcFullText, PmcFullTextFormat, PmcId, Pmid
    '                     PubDate, Title, Volume
    ' 
    '         Function: ToString
    ' 
    '     Class SearchOptions
    ' 
    '         Properties: CancellationToken, FetchPmcFullText, OutputDirectory, PreferredPmcFormat, RetMax
    '                     RetStart, Sort, Term, TimeoutSeconds
    ' 
    '     Class PubMedEUtilities
    ' 
    '         Constructor: (+1 Overloads) Sub New
    ' 
    '         Function: BuildCitation, CleanText, ConvertPmcXmlToHtml, ConvertPmcXmlToText, ConvertTableElementToHtml
    '                   FindAttributeByLocalName, FormatPubDate, GetElementValue, HtmlEncode, MakeSafeFileName
    '                   ParsePubmedXml, RenderInlineHtml, UrlEncode
    ' 
    '         Sub: AppendCommonParams, Configure, RenderNodeInline, RenderSectionToHtml, RenderSectionToText
    '              RenderTableToText, SetTimeout, UpdateUserAgent, WritePmcToFile
    ' 
    ' 
    ' /********************************************************************************/
