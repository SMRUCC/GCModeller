#Region "Microsoft.VisualBasic::a6dbc6831d50315cd670edc77b491c9f, R#\annotationKit\PtfCache.vb"
    ...
    '   Total Lines: 566
    '    Code Lines: 427 (75.44%)
    ' Comment Lines: 66 (11.66%)
    '    - Xml Docs: 100.00%
    ' 
    '   Blank Lines: 73 (12.90%)
    '     File Size: 23.68 KB


    ' Module PTFCache
    ' 
    '     Function: createCluster, eggNOGtable, fromDataframe, getDatabaseList, IDMapping
    '               loadModel, loadXrefs, name_xrefs, ptfTable, read_eggNOG
    '               readPtf, summaryofXrefs, (+2 Overloads) writePtfFile, writePtfInternal
    ' 
    '     Sub: Main
    ' 
    ' /********************************************************************************/
