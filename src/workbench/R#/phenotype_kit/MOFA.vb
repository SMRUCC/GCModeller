...
Module MOFATools
    ...
    Public Function create_mofa(<RListObjectArgument> data As list, Optional opts As MOFAOptions = Nothing, Optional env As Environment = Nothing) As Object
        ...
        Using model As New MOFA(dataList, opts)
            model.Train()
            ...
            For i As Integer = 0 To dataList.Count - 1
                ...
                Dim rnaReconstructed = model.ReconstructView(i)
                Dim rnaSamples = dataList(i).SampleIds
                Dim rnaFeatures = dataList(i).FeatureNames
