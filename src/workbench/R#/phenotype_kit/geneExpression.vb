#Region "Microsoft.VisualBasic::611cc2e20c73ed0e9af6b5e59e70aa33, R#\phenotype_kit\geneExpression.vb"
    ...
    '   Total Lines: 2173
    '    Code Lines: 1393 (64.10%)
    ' Comment Lines: 550 (25.31%)
    '    - Xml Docs: 93.82%
    ' 
    '   Blank Lines: 230 (10.58%)
    '     File Size: 89.12 KB
    ...
    '               setTag, setZero, sort_mad, splitCMeansClusters, take_shuffle
    '               toClusters, totalSumNorm, tr, Ttest, uniqueGeneId
    '               writeMatrix, zscore
    ' 
    '     Sub: Main
    ' 
    ...
    Public Function relative(matrix As Matrix, Optional median As Boolean = False) As Matrix
        Return New Matrix With {
            ...
            .expression = matrix.expression _
                .Select(Function(gene)
                            Return gene.RelativeScale(median)
                        End Function) _
                .ToArray,
            .tag = $"relative_scaale({matrix.tag})"
        }
    End Function
