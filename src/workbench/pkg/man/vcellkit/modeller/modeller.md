...
+ [taxonomy_info](modeller/taxonomy_info.1) get taxonomy information of the virtual cell model, this information will be used for identify the model source, and also for the model annotation in the future.
