...
+ [set_context](genomics_context/set_context.1) 
...
+ [is.forward](genomics_context/is.forward.1) assert that does the given nucleotide location is in forward direction?
