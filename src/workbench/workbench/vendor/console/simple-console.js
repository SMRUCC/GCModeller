...
(function (System) {
    ...
    System.add_command_history_icon = add_command_history_icon;
    ;
    ...
    (function (ConsoleUI) {
        var add_popup_button = /** @class */ (function () {
            function add_popup_button(update_popup, console) {
                ...
                System.add_command_history_icon(this.popup_button);
            ...
            add_popup_button.prototype.mousedown = function (e) {
                if (this.popup_is_open()) {
                    if (!(e.target.closest(".popup-button") == this.popup_button ||
    ...
    (function (ConsoleUI) {
        var add_popup_menu_button = /** @class */ (function () {
            function add_popup_menu_button(get_items, console) {
                var _this = this;
                var popup_button = new ConsoleUI.add_popup_button(function (menu) { return _this.menu_update(menu, get_items); }, console);
