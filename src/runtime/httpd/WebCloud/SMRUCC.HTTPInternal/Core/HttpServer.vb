...
#End If
        ...
        Public MustOverride Sub handlePOSTRequest(p As HttpProcessor, inputData As Stream)
        Public MustOverride Sub handlePUTMethod(p As HttpProcessor, inputData As Stream)
