#Region "Microsoft.VisualBasic::e9acb85a875096fa201c43765825e9d2, ..\httpd\WebCloud\SMRUCC.WebCloud.GIS\MaxMind\MySQL\geolite2\geolite2_country_blocks_ipv4.vb"
...
''' </summary>
''' <remarks></remarks>
<Oracle.LinuxCompatibility.MySQL.Reflection.DbAttributes.TableName("geolite2_country_blocks_ipv4", Database:="maxmind_geolite2", SchemaSQL:="
CREATE TABLE `geolite2_country_blocks_ipv4` (
  `network` varchar(32) NOT NULL,
  `geoname_id` varchar(45) DEFAULT NULL,
  `registered_country_geoname_id` varchar(45) DEFAULT NULL,
...
Public Class geolite2_country_blocks_ipv4: Inherits Oracle.LinuxCompatibility.MySQL.SQLTable
#Region "Public Property Mapping To Database Fields"
    <DatabaseField("network"), PrimaryKey, NotNull, DataType(MySqlDbType.VarChar, "32")> Public Property network As String
