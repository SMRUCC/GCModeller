...
#Region "所使用的激活函数的配置"
    ...
    <DataFrameColumn> Public Property input_active As String = default_active
    ''' <summary>
    ''' 推荐<see cref="ReLU"/>
    ''' </summary>
    ''' <returns></returns>
    <DataFrameColumn> Public Property hiddens_active As String = default_active
    <DataFrameColumn> Public Property output_active As String = default_active
#End Region
