#Region "Microsoft.VisualBasic::fa76649514c0631fea38f89dc5abb6df, ..\sciBASIC#\mime\RDF\RDFEntity.vb"
...
Public MustInherit Class RDFEntity : Inherits RDFProperty
    ...
    ''' </summary>
    ''' <returns></returns>
    <XmlAttribute(RDF.RDF_PREFIX & "about")> Public Property about As String Implements INamedValue.Identifier, IReadOnlyId.Identity
    ''' <summary>
    ''' [属性]   是拥有名称的资源
