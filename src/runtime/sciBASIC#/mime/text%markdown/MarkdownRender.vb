#Region "Microsoft.VisualBasic::7517fd2c34db7dbcbe5a9f2035763747, mime\text%markdown\MarkdownRender.vb"
    ...
    '   Total Lines: 374
    '    Code Lines: 270 (72.19%)
    ' Comment Lines: 19 (5.08%)
    '    - Xml Docs: 73.68%
    ' 
    '   Blank Lines: 85 (22.73%)
    '     File Size: 14.26 KB
