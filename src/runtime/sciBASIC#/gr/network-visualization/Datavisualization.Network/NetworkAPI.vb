#Region "Microsoft.VisualBasic::31cdec9ca139a9c8484bf1bb22ac83d8, gr\network-visualization\Datavisualization.Network\NetworkAPI.vb"
...
' Module NetworkAPI
' 
'     Function: FromCorrelations, GetConnections, GetNetworkNodes, GetNextConnects, GetNHetworkEdges
'               ReadnetWork, SaveNetwork, WriteNetwork
' 
' /********************************************************************************/
...
Public Module NetworkAPI
    ...
    Public Function EndPoints(network As Graph.NetworkGraph) As (input As Graph.Node(), output As Graph.Node())
        Return New GraphTheory.Network.NetworkGraph(network.nodes, network.edges).EndPoints
    End Function
