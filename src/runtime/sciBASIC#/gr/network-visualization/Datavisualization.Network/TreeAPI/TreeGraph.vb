...
Public NotInheritable Class TreeGraph(Of K, V)
    ...
    Public Shared Function CreateGraph(tree As BinaryTree(Of K, V), uniqueId As Func(Of V, String), keyId As Func(Of K, String)) As NetworkGraph
        ...
        Call appendGraph(g, root, tree, uniqueId, keyId)
        Return g
    End Function

    Private Shared Sub appendGraph(g As NetworkGraph, center As Node, tree As BinaryTree(Of K, V), uniqueId As Func(Of V, String), keyId As Func(Of K, String))
        ...
        If Not tree.Left Is Nothing Then
            ...
            appendGraph(g, v, tree.Left, uniqueId, keyId)
        End If
        ...
        If Not tree.Right Is Nothing Then
            ...
            v = g.CreateNode(clusterId, New NodeData With {.Properties = New Dictionary(Of String, String) From {{NamesOf.REFLECTION_ID_MAPPING_NODETYPE, clusterId}}})
            g.CreateEdge(v, center)
            appendGraph(g, v, tree.Right, uniqueId, keyId)
        End If
    End Sub
End Class
