...
Namespace DecisionTree
    ...
    Public Class Tree
        ...
        Private Shared Function CheckIfIsLeaf(root As TreeNode, data As DataTable, attributeToCheck As String) As Boolean
            Dim isLeaf = True
        ...
        Private Shared Function CreateSmallerTable(data As DataTable, edgePointingToNextNode As String, rootTableIndex As Integer) As DataTable
        ...
        Private Shared Function CalculateTableEntropy(data As DataTable) As Double
            Dim totalRows = data.Rows.Count
        ...
        Private Shared Function GetAmountOfEdgesAndTotalPositivResults(data As DataTable, indexOfColumnToCheck As Integer) As List(Of Integer(,))
        ...
        Private Shared Function CountKnownValues(data As DataTable, indexOfColumnToCheck As Integer) As IEnumerable(Of String)
