...
Namespace sample
    ...
    ''' 
    ''' 
    ''' </summary></br></br></br></summary>    Public Class Gibbs
        ...
        Public Sub New(ByVal seqArray As String(), ByVal motifLength As Integer)
            sample.Gibbs.sequences.AddRange(Arrays.asList(seqArray))
        ...
        Private Sub sample()
            For j = 0 To 1999
                ...
                Dim chosenSeqIndex = rand.Next(sample.Gibbs.sequences.Count)
                Dim chosenSequence As String = sample.Gibbs.sequences(chosenSeqIndex)
        ...
        Private Function calculateQ(ByVal tempMotif As String, ByVal chosenSeqIndex As Integer, ByVal possibleStart As Integer) As Double
            ...
            Dim denominator As Double = sample.Gibbs.sequences.Count - 1
            For Each s As String In sample.Gibbs.sequences
                Dim numerator As Double = 0
                If s.Equals(sample.Gibbs.sequences(chosenSeqIndex)) Then
                    Continue For
                End If
        ...
        Private Function generateRandomValue() As Dictionary(Of String, Integer?)
            ...
            For Each seq As String In sample.Gibbs.sequences
