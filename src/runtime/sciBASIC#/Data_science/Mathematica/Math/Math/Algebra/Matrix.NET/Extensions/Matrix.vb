'#Region "Microsoft.VisualBasic::94ee29d9a2c1a6a61dff464f2274ca9e, Data_science\Mathematica\Math\Math\Algebra\Matrix\Matrix.vb"
...
'        ''' 
'        ''' </summary>
'        ''' <param name="m">nrow</param>
'        ''' <param name="n">ncol</param>
'        Public Sub New(m%, n%)
'            Me.M = m
'            Me.N = n
...
'        Public Shared Function Create(nrow%, ncol%) As Matrix
