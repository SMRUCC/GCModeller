...
Module Program
    ...
    Public Sub RunFitProcess(trainingSet As DataSet, validateSet As DataSet, outFile$, seed As GridMatrix, popSize%, factorNames$(),
        ...
        If bigdataMode Then
            ...
            Dim population As Population(Of SparseGenome) = New SparseGenome(chromesome, mutationRate, truncate).InitialPopulation(New Population(Of SparseGenome)(parallel) With {.capacitySize = popSize})
        ...
        Else
            ...
            Dim population As Population(Of Genome) = New Genome(chromesome, mutationRate, truncate).InitialPopulation(New Population(Of Genome)(parallel) With {.capacitySize = popSize})
            Call "Initialize environment".__DEBUG_ECHO
