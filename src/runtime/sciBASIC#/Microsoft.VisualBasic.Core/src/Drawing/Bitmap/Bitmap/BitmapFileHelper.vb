...
Namespace Imaging.BitmapImage.FileStream
    Public Module BitmapFileHelper
        ...
        Public Function ReadFileAsBitmap(fileName As String, Optional flipRows As Boolean = False) As Bitmap
            ...
            If fileInfo.Length <= BitmapFileHeader.BitmapFileHeaderSizeInBytes Then Throw New Exception($"Invalid file format. Size is too small.")
            ...
            Using fileStream = File.OpenRead(fileName)
                Using bReader = New SafeBinaryReader(fileStream)
                    ...
                    If fileInfo.Length <> fileHeader.FileSize Then Throw New Exception($"File size is different than in header.")
                    ...
                    Dim bitmap = New Bitmap(width, height, pixelData:=pixelData, bitsPerPixel:=infoHeader.BitsPerPixel)
                    Return bitmap
