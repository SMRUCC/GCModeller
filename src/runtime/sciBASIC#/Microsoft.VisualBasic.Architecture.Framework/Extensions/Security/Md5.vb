#Region "Microsoft.VisualBasic::3ac098f2c42db43497131448aa3442ba, ..\sciBASIC#\Microsoft.VisualBasic.Architecture.Framework\Extensions\Security\Md5.vb"
...
Namespace SecurityString
    ...
    <PackageAttribute("Md5Hash", Publisher:="Microsoft Corp.", Description:="Represents the abstract class from which all implementations of the System.Security.Cryptography.MD5 hash algorithm inherit.")>
