# Session
_namespace: [FBA.Settings](./index.md)_
...
#### Finallize
```csharp
FBA.Settings.Session.Finallize
```
Close the application session and save the settings file.

#### FolkShoalThread
```csharp
FBA.Settings.Session.FolkShoalThread(System.String,System.String)
```
