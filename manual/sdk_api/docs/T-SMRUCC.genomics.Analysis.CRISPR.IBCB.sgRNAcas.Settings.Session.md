...
# Session
_namespace: [SMRUCC.genomics.Analysis.CRISPR.IBCB.sgRNAcas.Settings](N-SMRUCC.genomics.Analysis.CRISPR.IBCB.sgRNAcas.Settings.html)_
...
#### Finallize
```csharp
SMRUCC.genomics.Analysis.CRISPR.IBCB.sgRNAcas.Settings.Session.Finallize
```
Close the application session and save the settings file.

#### FolkShoalThread
```csharp
SMRUCC.genomics.Analysis.CRISPR.IBCB.sgRNAcas.Settings.Session.FolkShoalThread(System.String,System.String)
```
...
#### Initialize
```csharp
SMRUCC.genomics.Analysis.CRISPR.IBCB.sgRNAcas.Settings.Session.Initialize(System.Type)
```
Initialize the application session and get the program profile data.(初始化应用程序会话，并获取应用程序的配置数据)

#### TryGetShoalShellBin
```csharp
SMRUCC.genomics.Analysis.CRISPR.IBCB.sgRNAcas.Settings.Session.TryGetShoalShellBin
```
