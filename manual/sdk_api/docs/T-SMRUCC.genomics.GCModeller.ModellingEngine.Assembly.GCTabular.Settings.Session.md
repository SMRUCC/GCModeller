...
# Session
_namespace: [SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.GCTabular.Settings](N-SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.GCTabular.Settings.html)_
...
#### Finallize
```csharp
SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.GCTabular.Settings.Session.Finallize
```
Close the application session and save the settings file.

#### FolkShoalThread
```csharp
SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.GCTabular.Settings.Session.FolkShoalThread(System.String,System.String)
```
...
#### Initialize
```csharp
SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.GCTabular.Settings.Session.Initialize(System.Type)
```
Initialize the application session and get the program profile data.(初始化应用程序会话，并获取应用程序的配置数据)

#### TryGetShoalShellBin
```csharp
SMRUCC.genomics.GCModeller.ModellingEngine.Assembly.GCTabular.Settings.Session.TryGetShoalShellBin
```
