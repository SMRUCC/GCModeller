...
```csharp
SMRUCC.genomics.Analysis.AnnotationTools.AnnotationTool.GetAnnotationSourceMeta
```
获取所比对的蛋白质的信息的物种来源的信息

#### InvokeAnnotation
```csharp
SMRUCC.genomics.Analysis.AnnotationTools.AnnotationTool.InvokeAnnotation(System.String,System.String,System.Boolean,System.String)
```
