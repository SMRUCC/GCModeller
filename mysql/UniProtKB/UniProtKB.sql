...
CREATE TABLE IF NOT EXISTS `kb_UniProtKB`.`protein_functions` (
  ...
  `short_name1` VARCHAR(45) NULL,
  `short_name2` VARCHAR(45) NULL,
  `short_name3` VARCHAR(45) NULL,
  `protein_functionscol` VARCHAR(45) NULL,
